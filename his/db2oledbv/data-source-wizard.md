...
## Data Access Library  
 You can use the .NET Framework classes in the **Microsoft.HostIntegration.DataAccessLibrary** Namespace to automate defining packages and data sources. For the reference documentation, see [Microsoft.HostIntegration.DataAccessLibrary Namespace](/previous-versions/) (https://go.microsoft.com/fwlink/?LinkID=180763).