...
---
# FindSNAService
The **FindSNAService** function is written as a parallel to [CreateSNAService](../core/createsnaservice2.md). It is written to provide an easy way to access the keys for a particular service.  
