...
-   [PREPARE_TO_RECEIVE](../core/prepare-to-receive1.md) if **ptr_type** is set to AP_SYNC_LEVEL and the conversation's synchronization level (established by [ALLOCATE](../core/allocate1.md)) is AP_CONFIRM_SYNC_LEVEL  
  
-   [DEALLOCATE](../core/deallocate1.md) if **dealloc_type** is set to AP_SYNC_LEVEL and the conversation's synchronization level (established by **ALLOCATE**) is AP_CONFIRM_SYNC_LEVEL  
  
-   [SEND_DATA](../core/send-data2.md) if type is set to AP_SEND_DATA_CONFIRM and the conversation's synchronization level (established by **ALLOCATE**) is AP_CONFIRM_SYNC_LEVEL  
