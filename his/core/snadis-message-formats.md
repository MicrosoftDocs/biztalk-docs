...
-   Fields that occupy two bytes — the **srci** field in all messages, and fields such as **opresid** in [Open(LINK) Request](../core/open-link-request.md) — are represented with the arithmetically most significant byte in the lowest byte address, irrespective of the normal byte order used by the processor on which the software executes. That is, the 2-byte value 0x1234 has the byte 0x12 in the lowest byte address. The exception to this is the **startd** and **endd** fields in all elements, which are always stored in the processor's normal byte order.  
  
-   Messages are composed of buffers, consisting of a buffer header and zero or more buffer elements. For more information on buffer formats, see [Messages](../Topic/Messages%20\(SNADIS\)2.md).  
...
-   [Open(LINK)](../core/open-link.md)  
  
-   [Open(LINK) Request](../core/open-link-request.md)  
  
-   [Open(LINK) Response](../core/open-link-response.md)  
  
-   [Close(LINK)](../core/close-link.md)  
  
-   [Close(LINK) Request](../core/close-link-request.md)  
  
-   [Close(LINK) Response](../core/close-link-response.md)  
  
-   [Open(STATION)](../core/open-station.md)  
  
-   [Open(STATION) Request](../core/open-station-request.md)  
  
-   [Open(STATION) OK Response](../core/open-station-oresponse.md)  
  
-   [Open(STATION) Error Response](../core/open-station-error-response.md)  
  
-   [Close(STATION)](../core/close-station.md)  
  
-   [Close(STATION) Request](../core/close-station-request.md)  
  
-   [Close(STATION) Response](../core/close-station-response.md)  
  
-   [Request-Open-Station](../core/request-open-station.md)  
  
-   [Station-Contacted](../core/station-contacted.md)  
  
-   [Outage](../core/outage.md)  
  
-   [Status-Resource](../core/status-resource-snadis.md)  
  
-   [Send-XID](../core/send-xid.md)  
  
-   [DLC-Data](../core/dlc-data.md)