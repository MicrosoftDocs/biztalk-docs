---
title: "RECEIVE_IMMEDIATE2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
-   AP_SEND indicates, for the partner TP, the conversation has entered RECEIVE state. For the local TP, the conversation is now in SEND state. Upon receiving this value, the local TP normally uses [SEND_DATA](../core/send-data2.md)to begin sending data.  
...
## Return Codes  
 ...
 AP_DEALLOC_NORMAL  
 Primary return code; the partner TP has deallocated the conversation without requesting confirmation. The partner TP issued [DEALLOCATE](../core/deallocate1.md) with **dealloc_type** set to one of the following:  
...
1.  The local TP issues a receive verb until it finishes receiving a complete unit of data. The data received can be:  
    ...
    -   A buffer of data received independent of its logical-record format.  
     ...
     The receive verbs are [RECEIVE_AND_POST](../core/receive-and-post2.md), [RECEIVE_AND_WAIT](../core/receive-and-wait1.md), and **RECEIVE_IMMEDIATE**.  
