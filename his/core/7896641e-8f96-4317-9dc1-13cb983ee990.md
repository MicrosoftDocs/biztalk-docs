...
|-----------------------|-------------|  
|[CommandLineAdd](../Topic/CommandLineAdd1.md)|Called from **LinkCfg** to parse command-line input.|  
|[ConfigureLinkService](../Topic/ConfigureLinkService2.md)|Called from SNA Manager to add or modify a link service.|  
|[ConfigureLinkServiceEx](../Topic/ConfigureLinkServiceEx2.md)|Called from SNA Manager to add or modify a link service, returning a configuration buffer to be added to the configuration file.|  
|[DisplayHelpInfo](../Topic/DisplayHelpInfo1.md)|Returns a buffer containing command-line syntax for this type of link service.|  
|[RemoveLinkService](../Topic/RemoveLinkService2.md)|Called from SNA Manager to remove a link service.|  
|[RemoveAllLinkServices](../Topic/RemoveAllLinkServices2.md)|Called from Setup to remove all instances of this link service.|  
...
|----------------------|-------------|  
|[AddPerfmonCounters](../Topic/AddPerfmonCounters2.md)|Add Perfmon counters for this link service.|  
|[bCreateService](../Topic/bCreateService1.md)|Create a service on a computer.|  
|[bDeleteService](../Topic/bDeleteService2.md)|Delete a service on a computer.|  
|[bStopService](../Topic/bStopService1.md)|Stop a service running on a computer.|  
|[CheckForExistingLinkService](../Topic/CheckForExistingLinkService2.md)|Check to see if a link service of this type exists with this title.|  
|[ConvertHexStringToDWORD](../Topic/ConvertHexStringToDWORD1.md)|Convert a hexadecimal string to a DWORD value.|  
|[ExtractNextParameter](../Topic/ExtractNextParameter1.md)|Get the next parameter from a buffer.|  
|[fAddRegistryEntry](../Topic/fAddRegistryEntry1.md)|Add a new registry value to the registry.|  
|[fCanWeAdministerRemoteBox](../Topic/fCanWeAdministerRemoteBox2.md)|Determine if the user has administrative privileges on the remote computer.|  
|[fConnectRegistry](../Topic/fConnectRegistry2.md)|Connect to a remote computer's registry and return a handle to the remote registry.|  
|[fDisconnectRegistry](../Topic/fDisconnectRegistry2.md)|Disconnect from a remote computer's registry.|  
|[fFindAndReplaceString](../Topic/fFindAndReplaceString1.md)|Find and replace a substring within a string.|  
|[fFindString](../Topic/fFindString2.md)|Determine if a string exists within a string buffer.|  
|[fFindStringInMultiSZ](../Topic/fFindStringInMultiSZ2.md)|Find a string in a REG_MULTI_SZ string list and return entire string.|  
|[fQueryRegistryValue](../Topic/fQueryRegistryValue1.md)|Query a value from the registry.|  
|[fRegistryKeyExists](../Topic/fRegistryKeyExists1.md)|Test whether a registry key exists.|  
|[fRemoveRegistryEntry](../Topic/fRemoveRegistryEntry2.md)|Remove a registry key.|  
|[fRemoveRegistryValue](../Topic/fRemoveRegistryValue1.md)|Remove a registry value.|  
|[fStringCompare](../Topic/fStringCompare1.md)|Determine if two strings compare.|  
|[LoadStringResource](../Topic/LoadStringResource1.md)|Load a string from the string resource.|  
|[ParseNextField](../Topic/ParseNextField1.md)|Return the next field from a string.|  
|[RemovePerfmonCounters](../Topic/RemovePerfmonCounters2.md)|Remove Perfmon counters for this link service.|  
