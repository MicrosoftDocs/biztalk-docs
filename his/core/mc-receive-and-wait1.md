---
title: "MC_RECEIVE_AND_WAIT1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: dc4922a2-e445-4d27-a56e-f76bc03f84dd
...
The **MC_RECEIVE_AND_WAIT** verb receives any data that is currently available from the partner transaction program (TP). If no data is currently available, the local TP waits for data to arrive.  
 ...
 To allow full use to be made of the asynchronous support, asynchronously issued **MC_RECEIVE_AND_WAIT** verbs have been altered to act like [MC_RECEIVE_AND_POST](../core/mc-receive-and-post1.md) verbs. Specifically, while an asynchronous **MC_RECEIVE_AND_WAIT** is outstanding, the following verbs can be issued on the same conversation:  
 ...
 *conv_id*  
 ...
 The value of this parameter is returned by [MC_ALLOCATE](../core/mc-allocate1.md) in the invoking TP or by **RECEIVE_ALLOCATE** in the invoked TP.  
...
1.  The local TP issues a receive verb until it finishes receiving a complete unit of data. The data received is one data record.  
     ...
     The receive verbs are [MC_RECEIVE_AND_POST](../core/mc-receive-and-post1.md), **MC_RECEIVE_AND_WAIT**, and [MC_RECEIVE_IMMEDIATE](../core/mc-receive-immediate1.md).  
