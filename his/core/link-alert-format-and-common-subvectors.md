...
```  
 ...
 The specific alert is identified by the alert description and alert ID (part of the generic alert subvector). Common subvectors are listed later in this section. SDLC and Token Ring failure alerts are described in the [SDLC Failure Alerts](../core/sdlc-failure-alerts.md) and [Token Ring Failure Alerts](../core/token-ring-failure-alerts.md).  
