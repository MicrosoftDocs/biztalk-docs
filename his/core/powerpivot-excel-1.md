...
7.  In the **Connection** tab, click **Browse** to locate an existing UDL file. Alternatively, configure a new connection. For more information, see [Data Links (DB2)](../core/data-links-db2-1.md).  
