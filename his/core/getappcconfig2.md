...
## Synchronous Return Codes  
 ...
 The Windows APPC library needs to be initialized by a call to [WinAPPCStartup](../core/winappcstartup2.md) before calling **GetAppcConfig** and this has not been done.  
...
## Remarks  
 [WinAPPCStartup](../core/winappcstartup2.md) must be called before using **GetAppcConfig**.  
