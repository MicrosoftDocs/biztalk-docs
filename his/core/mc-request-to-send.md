...
-   AP_CONFIRM_SEND and replies with [MC_CONFIRMED](../core/mc-confirmed.md)  
  
-   AP_DATA_COMPLETE_CONFIRM_SEND and replies with **MC_CONFIRMED**  
  
-   AP_SEND  
  
 The receive verbs are [MC_RECEIVE_AND_POST](../core/mc-receive-and-post.md), [MC_RECEIVE_IMMEDIATE](../core/mc-receive-immediate.md), and [MC_RECEIVE_AND_WAIT](../core/mc-receive-and-wait.md).