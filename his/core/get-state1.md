 ...
 *tp_id*  
 Supplied parameter. Identifies the local transaction program (TP). The value of this parameter was returned by [TP_STARTED](../core/tp-started1.md) in the invoking TP or by [RECEIVE_ALLOCATE](../core/receive-allocate2.md) in the invoked TP.  
  
 *conv_id*  
 Supplied parameter. Provides the identifier for the conversation about which this TP is inquiring. The value of this parameter was returned by [MC_ALLOCATE](../core/mc-allocate1.md) or [ALLOCATE](../core/allocate1.md) in the invoking TP or by **RECEIVE_ALLOCATE** in the invoked TP.  
