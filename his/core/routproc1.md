---
title: "routproc1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: ec34b3f2-6eba-4294-a3e9-64214d10b89e
...
## Remarks  
 The routing procedure should first call [sbpurcvx](../core/sbpurcvx2.md), which handles any Open response messages, as follows:  
...
-   If the message is not for this application, return **FALSE** so that the DMOD tries further routing procedures.  
 ...
 If the message is for this application, the routing procedure can either process the message immediately or put the message on an application queue, and then post the application using a semaphore. For more information, see [Receiving Messages](../core/receiving-messages2.md).