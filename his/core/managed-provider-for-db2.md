...
## In This Section  
 [Managed Provider for DB2 Goals](../core/managed-provider-for-db2-goals.md)  
  
 [Relationships between the .NET Provider for DB2 Interfaces](../core/relationships-between-the-net-provider-for-db2-interfaces.md)