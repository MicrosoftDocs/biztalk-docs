...
|939|IBM English Extend lower case and IBM Japanese (for Japan)|  
 ...
 All other code pages delivered with [!INCLUDE[hishostintegrationserver2009](../core/includes/hishostintegrationserver2009-md.md)] are handled as Extended Binary Coded Decimal Interchange Code (EBCDIC) code pages, which use a single byte to represent a character.  
