...
---
# SLI_PURGE
The **SLI_PURGE** verb cancels [SLI_RECEIVE](../core/sli-receive1.md) verbs issued with a wait condition.  
 ...
 **lua_data_ptr**  
 When **SLI_PURGE** is issued, this parameter points to the location of the [SLI_RECEIVE](../core/sli-receive1.md) verbs VCB that is to be canceled.  
...
## Return Codes  
 ...
 Secondary return code; no [SLI_RECEIVE](../core/sli-receive1.md) was outstanding when you issued **SLI_PURGE**. One of two situations caused the problem:  
...
## Remarks  
 **SLI_PURGE** cancels [SLI_RECEIVE](../core/sli-receive1.md) commands with a wait condition.  
