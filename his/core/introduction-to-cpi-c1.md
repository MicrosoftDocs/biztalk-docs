...
-   [Windows CPI-C Asynchronous Support](../core/windows-cpi-c-asynchronous-support2.md)  
  
-   [Windows CPI-C Considerations](../core/windows-cpi-c-considerations2.md)  
  
-   [Asynchronous Call Completion](../core/asynchronous-call-completion2.md)  
  
-   [Initial Conversation Characteristics](../core/initial-conversation-characteristics2.md)  
  
-   [Side Information for CPI-C Programs](../core/side-information-for-cpi-c-programs2.md)  
  
-   [Configuration for CPI-C Programs](../core/configuration-for-cpi-c-programs2.md)  
  
-   [CPI-C Considerations for Windows](../core/cpi-c-considerations-for-windows1.md)  
  
-   [Finding Further Information about CPI-C](../core/finding-further-information-about-cpi-c1.md)