...
-   [Deallocate](../core/deallocate-cpi-c-2.md) with the conversations deallocate type set to CM_DEALLOCATE_ABEND  
  
-   [Send_Data](../core/send-data-cpi-c-1.md) with the conversations send type set to CM_SEND_AND_DEALLOCATE and the deallocate type set to CM_DEALLOCATE_ABEND  
