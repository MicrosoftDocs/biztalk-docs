...
-   [Receive](../core/receive-cpi-c.md) with receive type set to CM_RECEIVE_AND_WAIT  
...
-   CM_CONFIRM_SEND_RECEIVED and the local program replies with a [Confirmed](../core/confirmed-cpi-c.md) call  
