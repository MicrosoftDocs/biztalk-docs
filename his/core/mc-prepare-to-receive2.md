---
title: "MC_PREPARE_TO_RECEIVE2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 6c094b92-d1c3-4cd8-91ce-211966865e52
...
-   AP_CONFIRM_SEND and replies with [MC_CONFIRMED](../core/mc-confirmed2.md)  
  
-   AP_DATA_COMPLETE_CONFIRM_SEND and replies with **MC_CONFIRMED**  
  
-   AP_DATA_CONFIRM_SEND and replies with **MC_CONFIRMED**  
  
 The receive verbs are [MC_RECEIVE_AND_POST](../core/mc-receive-and-post1.md), [MC_RECEIVE_IMMEDIATE](../core/mc-receive-immediate1.md), and [MC_RECEIVE_AND_WAIT](../core/mc-receive-and-wait1.md).