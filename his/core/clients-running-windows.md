---
title: "Clients Running Windows1 | Microsoft Docs"
ms.custom: ""
ms.date: "10/13/2017"
...
> [!NOTE]
>  Before an autostarted TP can be started as an application on a Windows client, the TPSTART program must be started. For more information, see [APPC Samples](../Topic/APPC%20Samples.md).  
