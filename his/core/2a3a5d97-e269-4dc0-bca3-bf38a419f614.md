...
##  <a name="upgrade"></a> Upgrading .NET Assemblies  
 ...
 IMS Implicit and IMS Explicit are no longer supported in [!INCLUDE[hishostintegrationserver2009](../includes/hishostintegrationserver2009-md.md)] and will be converted to the IMS Connect programming model when converted using the TIConversionTool.exe. For more information, see [IMS Connect](ims-connect1.md).  
