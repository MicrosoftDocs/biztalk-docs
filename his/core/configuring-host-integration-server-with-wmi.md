...
## In This Section  
 [How to Configure an IPDLC Link Service](../core/how-to-configure-an-ipdlc-link-service.md)  
  
 [How to Retrieve an Adapter Name](../core/how-to-retrieve-an-adapter-name.md)  
  
 [How to Create a Link Service](../core/how-to-create-a-link-service.md)  
  
 [How to Create an Independent Session](../core/how-to-create-an-independent-session.md)  
  
 [How to Handle Errors While Creating a Link Service](../core/how-to-handle-errors-while-creating-a-link-service.md)