...
-   An invokable TP is matched to an invoking TP's request.  
 ...
 For information about how to configure logical units (LUs) to support TPs, see [Configuring Host Integration Server to Support TPs](../core/configuring-host-integration-server-to-support-tps-cpi-c-2.md).  
  
 This section contains:  
  
-   [Invoking TPs](../core/invoking-tps-cpi-c-1.md)  
  
-   [Invoking TPs and Contention](../core/invoking-tps-and-contention-cpi-c-2.md)  
  
-   [Invokable TPs](../core/invokable-tps-cpi-c-1.md)  
  
-   [Subcategories for Invokable TPs](../core/subcategories-for-invokable-tps-cpi-c-2.md)  
  
-   [Matching Invoking and Invokable TPs](../core/matching-invoking-and-invokable-tps-cpi-c-2.md)