...
|Method|Description|  
|------------|-----------------|  
|[Start](../core/mssna-connection-start-method2.md)|Starts the connection.|  
|[Stop](../core/mssna-connection-stop-method2.md)|Stops the connection.|  
|[ExchangePassthroughLus](../core/mssna-connection-exchangepassthroughlus-method1.md)|Returns a value that determines if two LUs are part of a passthrough connection pair.|  
