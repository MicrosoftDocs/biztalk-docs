 ...
 *lua_resv56*  
 Supplied parameter. A reserved field used by **RUI_INIT** and [SLI_OPEN](../core/sli-open.md). All other reserved fields in the array must be left blank. For more information, see the discussion of these Host Integration Server extensions in the Remarks section.  
 ...
 Supplied parameter. Indicates whether incomplete reads are supported. If this parameter is set to a nonzero value, incomplete or truncated reads are supported. For more details, see the remarks for [RUI_READ](../core/rui-read.md).  
...
## Return Codes  
 ...
 Secondary return code; [RUI_TERM](../core/rui-term.md) was issued before **RUI_INIT** completed.  
...
## Remarks  
 This verb must be the first LUA verb issued for the session. Until this verb has completed successfully, the only other LUA verb that can be issued for this session is [RUI_TERM](../core/rui-term.md) (which terminates a pending **RUI_INIT**).  
...
>  All other reserved fields must be left blank.  
 ...
 For more information, see the description of the [sepdcrec](../core/sepdcrec.md) function in the section of the Software Development Kit (SDK) Help on the 3270 Emulator Interface Specification.  
