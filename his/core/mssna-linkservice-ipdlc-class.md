...
|Method|Description|  
|------------|-----------------|  
|[GetAllStaticIPs](../core/mssna-linkservice-ipdlc-getallstaticips-method.md)|Returns the list of all the static IP addresses on the local machine.|  
|[GetAllNetworkAdapters](../core/mssna-linkservice-ipdlc-getallnetworkadapters-method.md)|Returns the list of all network adapters with the IP protocols enabled.|  
|[GetNextAvailableOrdinal](../core/mssna-linkservice-ipdlc-getnextavailableordinal-method.md)|Internal. Provides the next available link service number.|  
