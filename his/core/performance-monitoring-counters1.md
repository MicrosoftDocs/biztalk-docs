...
## In This Section  
 [Method Calls per Second](../core/method-calls-per-second1.md)  
  
 [Average Method Call Time](../core/average-method-call-time1.md)  
  
 [Errors Per Second](../core/errors-per-second1.md)  
  
 [Host Response Time](../core/host-response-time1.md)  
  
 [Bytes Sent Per Second](../core/bytes-sent-per-second1.md)  
  
 [Bytes Received Per Second](../core/bytes-received-per-second2.md)