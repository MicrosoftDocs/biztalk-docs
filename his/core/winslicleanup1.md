...
## Remarks  
 ...
 If **WinSLICleanup** is called while LUs are in session ([SLI_CLOSE](../core/sli-close2.md) not issued), the cleanup code should issue an **SLI_CLOSE** close type ABEND for the application for all open sessions.  
