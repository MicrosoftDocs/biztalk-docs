...
|[Start](../core/mssnastatus-printsession-start-method1.md)|Starts the print session.|  
|[Stop](../core/mssnastatus-printsession-stop-method1.md)|Stops the print session.|  
|[Pause](../core/mssnastatus-printsession-pause-method1.md)|Pauses the print session.|  
|[Restart](../core/mssnastatus-printsession-restart-method2.md)|Restarts the print session.|  
|[PA1Key](../core/mssnastatus-printsession-pa1key-method2.md)|Simulates pressing the PA1Key.|  
|[PA2Key](../core/mssnastatus-printsession-pa2key-method1.md)|Simulates pressing the PA2Key.|  
|[Cancel](../core/mssnastatus-printsession-cancel-method2.md)|Cancels the print session.|  
