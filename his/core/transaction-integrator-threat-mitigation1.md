---
title: "Transaction Integrator Threat Mitigation1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 7e2301d2-105a-4c20-929b-93b776e8e256
...
-   [Protect the MSHIS60_HIP Database and SQL Server Stored Procedures](../core/protect-the-mshis60-hip-database-and-sql-server-stored-procedures2.md)  
  
-   [Protect the COM+ and .NET Servers](../core/protect-the-net-servers2.md)  
  
-   [Protect the Raw User Data](../core/protect-the-raw-user-data2.md)  
  
-   [Protect the HIP Listener](../core/protect-the-hip-listener1.md)  
  
-   [Protect the Local File System, Database, and Registry](../core/protect-the-local-file-system-database-and-registry2.md)  
  
-   [Protect the Client Proxy](../core/protect-the-client-proxy2.md)  
  
-   [Protect the Remoting Session](../core/protect-the-remoting-session2.md)  
  
-   [Protect TI from Unauthorized Mainframe or AS/400 Access](../core/protect-ti-from-unauthorized-mainframe-or-as-400-access2.md)  
  
-   [Protect the TI Runtime Environment](../core/protect-the-ti-runtime-environment2.md)  
  
-   [Protect Mainframe Security Credentials from Being Overridden](../core/protect-mainframe-security-credentials-from-being-overridden2.md)  
  
-   [Protect the TI Runtime and Host Environments from Data Overflows](../core/protect-the-ti-runtime-and-host-environments-from-data-overflows1.md)  
  
-   [Protecting the TI .NET Assembly from Unauthorized Access](../core/protecting-the-ti-net-assembly-from-unauthorized-access1.md)  
  
-   [Protecting the Output from Tracing and Network Monitoring Activities](../core/protecting-the-output-from-tracing-and-network-monitoring-activities1.md)  
