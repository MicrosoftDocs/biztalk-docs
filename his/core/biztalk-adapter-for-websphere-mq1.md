---
title: "BizTalk Adapter for WebSphere MQ1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 1939394e-be04-418e-bcfc-0975a0a0f9d7
...
## In This Section  
 [MQSC Adapter Features](../core/mqsc-adapter-features1.md)  
  
 [How to Add the MQSC Adapter to a BizTalk Server Installation](../core/how-to-add-the-mqsc-adapter-to-a-biztalk-server-installation2.md)  
  
 [How to Configure a Send Port for the MQSC Adapter](../core/how-to-configure-a-send-port-for-the-mqsc-adapter1.md)  
  
 [How to Configure a Receive Port and a Receive Location for the MQSC Adapter](../core/how-to-configure-a-receive-port-and-a-receive-location-for-the-mqsc-adapter1.md)  
  
 [How to Configure a Client Channel Definition File](../core/how-to-configure-a-client-channel-definition-file1.md)  
  
 [How to Configure the MQSC Adapter for Transactional Messaging](../core/how-to-configure-the-mqsc-adapter-for-transactional-messaging1.md)  
  
 [How to Configure SSL for the MQSC Adapter: Transactional](../core/how-to-configure-ssl-for-the-mqsc-adapter-transactional1.md)  
  
 [MQSC Adapter Schema](../core/mqsc-adapter-schema1.md)