...
## Remarks  
 ...
 If the conversation is in SEND state, **TP_ENDED** performs the function of [DEALLOCATE](../core/deallocate1.md) or [MC_DEALLOCATE](../core/mc-deallocate1.md) with **dealloc_type** set to AP_FLUSH.  
