...
-   The application should reflect the source and destination Locality Partner Index (LPIs) and the source and destination names from the [Open(PLU) Request](../core/open-plu-request1.md) and must supply the I part of the source LPI.  
...
-   For LUA, the **BIND** RU is not preceded by its transmission header (TH) and response header (RH). This is in contrast with the [Open(PLU) Request](../core/open-plu-request1.md), where the TH and RH are included.  
