...
## Return Codes  
 ...
 Secondary return code; the verb was canceled because [RUI_TERM](../core/rui-term1.md) was issued for this session.  
...
## Remarks  
 [RUI_INIT](../core/rui-init2.md) must be issued successfully before this verb is issued.  
 ...
 **RUI_WRITE** can be issued on the SSCP normal flow at any time after a successful [RUI_INIT](../core/rui-init2.md). **RUI_WRITE** verbs on the LU expedited or LU normal flows are permitted only after a BIND has been received, and must abide by the protocols specified on the BIND.  
