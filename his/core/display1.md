...
The **DISPLAY** verb returns configuration information and current operating values for the SNA node.  
 ...
 It is recommended that you use the [GetAppcConfig](../core/getappcconfig2.md) Windows extension function to obtain system configuration information relating to APPC LUs. Users of 5250 emulators, in particular, should use the **GetAPPCConfig** Windows extension.  
...
## See Also  
 [Host Integration Server Extensions](../core/host-integration-server-extensions2.md)   
 [Differences by Information Type](../core/differences-by-information-type2.md)