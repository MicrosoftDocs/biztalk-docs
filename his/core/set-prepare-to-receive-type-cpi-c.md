 ...
 *prepare_to_receive_type*  
 Supplied parameter. Specifies how subsequent [Prepare_To_Receive](../core/prepare-to-receive-cpi-c.md) calls will be executed. Possible values are:  
 ...
 Used by the conversations synchronization level to determine prepare-to-receive processing. A default synchronization level is established by [Initialize_Conversation](../core/initialize-conversation-cpi-c.md) and can be overridden by [Set_Sync_Level](../core/set-sync-level-cpi-c.md).  
