...
4.  Set any registry or environment variables needed for the invoking and invokable TPs.  
     ...
     For information about registry or environment variables, see [Configuring Invokable TPs](../core/configuring-invokable-tps-cpi-c-1.md) and [Invoking TPs](../core/invoking-tps-cpi-c-2.md). For information about TPSETUP, see [CPI-C Samples](../core/cpi-c-samples.md).  
