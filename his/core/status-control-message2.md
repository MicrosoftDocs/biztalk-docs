...
RELQ|DFC,Exp|–|4|\<–>|–|CRELQ (0x22)|  
 ...
 The requests in the following table are used only with LUA. (For more information, see [FMI Concepts](../core/fmi-concepts2.md).)  
...
-   [Status-Control (ACKLUA) Message](../core/status-control-acklua-message2.md)