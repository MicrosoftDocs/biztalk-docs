...
## Members  
 ...
 tp_id  
 Supplied parameter. Identifies the local transaction program (TP). The value of this parameter was returned by [TP_STARTED](../core/tp-started.md) in the invoking TP, or by [RECEIVE_ALLOCATE](../core/receive-allocate.md) or RECEIVE_ALLOCATE_EX in the invoked TP.  
  
 plu_alias  
 Supplied parameter. Provides the identifier for the LU about which this TP is inquiring. The value of this parameter was returned by [MC_ALLOCATE](../core/mc-allocate.md) or [ALLOCATE](../core/allocate.md) in the invoking TP or by **RECEIVE_ALLOCATE** in the invoked TP.  
