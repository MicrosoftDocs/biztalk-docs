...
---
# SLI_CLOSE
The **SLI_CLOSE** verb ends a session opened with [SLI_OPEN](../core/sli-open1.md). The LU-LU and LU-SSCP resources are released.  
...
-   Either a CLOSE_ABEND or a CLOSE_NORMAL was still pending when a CLOSE_NORMAL was issued.  
 ...
 Secondary return code; unexpected data or commands were received from the host while [SLI_OPEN](../core/sli-open1.md) was processing.  
