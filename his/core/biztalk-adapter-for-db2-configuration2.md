...
## In This Section  
 [How to Create a Send Port for the DB2 Adapter](../core/how-to-create-a-send-port-for-the-db2-adapter1.md)  
 ...
 [How to Create a Schema for the DB2 Adapter](../core/how-to-create-a-schema-for-the-db2-adapter1.md)  
  
 [Creating a BizTalk Application with the DB2 Adapter](../core/creating-a-biztalk-application-with-the-db2-adapter.md)  
