 ...
 **Other Resources**  
 ...
 For more information about Windows Management Interface in HIS 2010, see [WMI and Host Integration Server](../core/wmi-and-host-integration-server2.md) in [Programmer's Guide](../core/programmer-s-guide1.md).  
