...
1.  Create or retrieve the connection string on which you run the sample query.  
     ...
     For more information about creating and retrieving connection strings, see [Creating a Connection String](../core/creating-a-connection-string2.md) and [How to Retrieve Data](../core/how-to-retrieve-data1.md).  
