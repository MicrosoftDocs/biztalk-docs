...
For the status codes used on [Status-Session](../core/status-session1.md) messages, the following table lists:  
...
-   On which sessions the combinations of primary and qualifying status codes can occur.  
 ...
 For an overall description of the role of the **Status-Session** message, see [Status-Session Message](../core/status-session-message2.md). The individual codes are discussed in [SSCP Connection](../core/sscp-connection2.md) and [PLU Connection](../core/plu-connection1.md).  
