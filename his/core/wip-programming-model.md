...
## In This Section  
 [Supported Conversational Model](../core/supported-conversational-model.md)  
  
 [TPs with Explicit SYNCPOINT Commands](../core/tps-with-explicit-syncpoint-commands.md)  
