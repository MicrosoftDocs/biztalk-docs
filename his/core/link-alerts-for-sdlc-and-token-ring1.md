...
## In This Section  
 [Link Alert Format and Common Subvectors](../core/link-alert-format-and-common-subvectors1.md)  
  
 [SDLC Failure Alerts](../core/sdlc-failure-alerts1.md)  
  
 [SDLC Alert Local Logging](../core/sdlc-alert-local-logging2.md)  
  
 [Token Ring Failure Alerts](../core/token-ring-failure-alerts2.md)  
  
 For information about the NetView vectors supported by the NVAlert service, see [Alerts Used by Applications and NVAlert](../core/alerts-used-by-applications-and-nvalert1.md).  
