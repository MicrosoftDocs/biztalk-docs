 ...
 **true** to log all TN3270 service event messages to the Event Log being used by the [!INCLUDE[hishostintegrationserver2009](../core/includes/hishostintegrationserver2009-md.md)] system, instead of to the Event Log on the local computer; otherwise, **false**.  
