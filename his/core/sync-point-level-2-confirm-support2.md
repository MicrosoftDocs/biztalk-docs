---
title: "Sync Point Level 2 Confirm Support2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 2db3adac-b385-4c1f-aeaa-b24099b3c74f
caps.latest.revision: 3
---
# Sync Point Level 2 Confirm Support
The current APPC implementation in Host Integration Server supports conversations with **synclevel** of AP_NONE, AP_CONFIRM_SYNC_LEVEL, or AP_SYNCPT. The [DEALLOCATE](../core/deallocate1.md), [MC_DEALLOCATE](../core/mc-deallocate1.md), [PREPARE_TO_RECEIVE](../core/prepare-to-receive1.md), and [MC_PREPARE_TO_RECEIVE](../core/mc-prepare-to-receive2.md) verbs specify a **type** member indicating the synchronization level required. This parameter is interpreted as follows:  
  
|Allocated synclevel|Type specified|Action performed|  
|-------------------------|--------------------|----------------------|  
|AP_NONE|AP_FLUSH|Action of [FLUSH](../core/flush1.md) or [MC_FLUSH](../core/mc-flush2.md) verb before deallocation or change of direction.|  
|AP_NONE|AP_SYNCLEVEL|Action of **FLUSH** or **MC_FLUSH** verb before deallocation or change of direction.|  
|AP_SYNCPT|AP_FLUSH|Action of [FLUSH](../core/flush1.md) or [MC_FLUSH](../core/mc-flush2.md) verb before deallocation or change of direction.|  
|AP_SYNCPT or  AP_CONFIRM_SYNC_LEVEL|AP_CONFIRM_TYPE|Action of [CONFIRM](../core/confirm1.md) or [MC_CONFIRM](../core/mc-confirm1.md) verb before deallocation or change of direction.|  
...
-   Intercept [DEALLOCATE](../core/deallocate1.md), [MC_DEALLOCATE](../core/mc-deallocate1.md), [PREPARE_TO_RECEIVE](../core/prepare-to-receive1.md), and [MC_PREPARE_TO_RECEIVE](../core/mc-prepare-to-receive2.md) verbs on Sync Point Level 2 conversations when type AP_SYNCLEVEL is specified for **synclevel**.  
...
-   On completion of the verb, issue the original **DEALLOCATE**, **MC_DEALLOCATE**, **PREPARE_TO_RECEIVE**, or **MC_PREPARE_TO_RECEIVE** verb to [!INCLUDE[hishostintegrationserver2009](../includes/hishostintegrationserver2009-md.md)].  
 ...
 The [DEALLOCATE](../core/deallocate1.md), [MC_DEALLOCATE](../core/mc-deallocate1.md), [PREPARE_TO_RECEIVE](../core/prepare-to-receive1.md), and [MC_PREPARE_TO_RECEIVE](../core/mc-prepare-to-receive2.md) verbs specify a type member indicating the synchronization level required. This parameter is interpreted as follows:  
...
|AP_CONFIRM_SYNC_LEVEL|AP_SYNCLEVEL|Action of [CONFIRM](../core/confirm1.md) or [MC_CONFIRM](../core/mc-confirm1.md) verb before deallocation or change of direction.|