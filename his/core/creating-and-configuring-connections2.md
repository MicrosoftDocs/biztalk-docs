...
## IP-DLC Link Service  
 For information on configuring an IP-DLC Link Service, see [Configuring an IP-DLC Link Service](../core/configuring-an-ip-dlc-link-service2.md) in this section.  
...
-   [Creating a 3270 Connection Using a Wizard](../core/creating-a-3270-connection-with-a-wizard2.md)  
  
-   [Creating a 3270 Connection Manually](../core/how-to-create-a-3270-connection-manually2.md)  
  
## AS/400 (5250) environments:  
  
-   [Creating a 5250 Connection Using a Wizard](../core/creating-a-5250-connection-with-a-wizard1.md)  
  
-   [Creating a 5250 Connection Manually](../core/how-to-create-a-5250-connection-manually1.md)  
  
-   [Creating a 5250 Local APPC LU](../core/how-to-create-a-5250-local-appc-lu2.md)  
  
-   [Creating a 5250 Remote APPC LU](../core/how-to-create-a-5250-remote-appc-lu2.md)  
 ...
 If you need to configure a connection manually, you may need to verify some of your connection information. For more information, see [Important Connection Information](../core/important-connection-information1.md).  
  
## See Also  
 [Configuring an IP-DLC Connection](../core/configuring-an-ip-dlc-connection1.md)