...
## In This Section  
 [How TI Associates a Method with a TP](../core/how-ti-associates-a-method-with-a-tp.md)  
  
 [How TI Enables TPs to Return Exceptions](../core/how-ti-enables-tps-to-return-exceptions.md)  
