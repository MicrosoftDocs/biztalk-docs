 ...
 **Other Resources**  
 ...
 For more information about Windows Management Interface in [!INCLUDE[hishostintegrationserver2009](../includes/hishostintegrationserver2009-md.md)], see [WMI and Host Integration Server](../core/wmi-and-host-integration-server2.md) in [Programmer's Guide](../core/programmer-s-guide1.md).  
