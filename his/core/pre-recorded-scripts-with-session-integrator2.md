---
title: "Pre-Recorded Scripts with Session Integrator2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 34e33732-fb72-438e-9be5-aac059415c35
...
|WAIT {seconds}|Waits the input number of seconds and then moves to the next command. The WAIT command can be replaced by the WAITFORSTRING command to wait for a specific string on the screen.|  
