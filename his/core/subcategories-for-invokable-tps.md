...
|Nonqueued|Running as an application|Autostarted|  
 ...
 To write an autostarted TP so it will run under Windows as a service and also run in a nonqueued way, write a multithreaded program with a [RECEIVE_ALLOCATE](../Topic/RECEIVE_ALLOCATE2.md) always outstanding. See [Invokable TPs](../core/invokable-tps.md).