---
title: "Flush (CPI-C)1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: e337a617-d414-4e60-a95a-79476b495726
...
## Remarks  
 Data processed by [Send_Data](../core/send-data-cpi-c-1.md) accumulates in the local LUs send buffer until one of the following happens:  
  
-   The local program issues the Flush call or other call that flushes the LUs send buffer. (Some send types, set by [Set_Send_Type](../core/set-send-type-cpi-c-1.md), include flush functionality.)  
  
-   The buffer is full.  
  
 The allocation request generated by [Allocate](../core/allocate-cpi-c-1.md) and error information generated by [Send_Error](../core/send-error-cpi-c-1.md) are also buffered.