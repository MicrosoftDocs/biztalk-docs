 ...
 **lua_data_ptr**  
 When **SLI_PURGE** is issued, this parameter points to the location of the [SLI_RECEIVE](../core/sli-receive.md) verbs VCB that is to be canceled.  
...
## Return Codes  
 ...
 Secondary return code; no [SLI_RECEIVE](../core/sli-receive.md) was outstanding when you issued **SLI_PURGE**. One of two situations caused the problem:  
...
## Remarks  
 **SLI_PURGE** cancels [SLI_RECEIVE](../core/sli-receive.md) commands with a wait condition.  
