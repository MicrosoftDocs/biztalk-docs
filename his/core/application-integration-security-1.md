...
## In This Section  
 ...
 [Special Security Settings for TCP/IP](../core/special-security-settings-for-tcp-ip2.md)  
  
 [Mainframe Authentication for CICS LINK](../core/mainframe-authentication-for-cics-link2.md)  
  
 [AS/400 Security](../core/as-400-security2.md)  
  
 [Limitations of User Access Level Sign On](../core/limitations-of-user-access-level-sign-on2.md)  
