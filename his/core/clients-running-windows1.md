...
> [!NOTE]
>  Before an autostarted TP can be started as an application on a Windows client, the TPSTART program must be started. For more information, see [APPC Samples](../HIS2010/appc-samples.md).  
