 ...
 **lua_flag1**  
 Supplied parameter. Contains a data structure containing flags for messages supplied by the application. This parameter is used by [RUI_BID](../core/rui-bid.md), [RUI_READ](../core/rui-read.md), [RUI_WRITE](../core/rui-write.md), [SLI_BID](../core/sli-bid.md), **SLI_RECEIVE_EX**, and [SLI_SEND_EX](../core/sli-send-ex.md). Its subparameters are as follows:  
 ...
 **lua_flag2**  
 Returned parameter. Contains flags for messages returned by LUA. Returned by [RUI_BID](../core/rui-bid.md), [RUI_READ](../core/rui-read.md), **RUI_WRITE**, **SLI_BID**, **SLI_RECEIVE**, and [SLI_SEND_EX](../core/sli-send-ex.md). Its subparameters are as follows:  
...
## Return Codes  
 ...
 Secondary return code; the buffer with the [SLI_BID](../core/sli-bid.md) VCB was released before the **SLI_RECEIVE_EX** with **lua_flag1.bid_enable** set to 1 was issued.  
 ...
 The supplied data segment for **SLI_RECEIVE_EX** or [SLI_SEND_EX](../core/sli-send-ex.md) is not a read/write data segment as required.  
 ...
 **SLI_RECEIVE_EX** receives responses, SNA commands, and request unit data from the host. **SLI_RECEIVE_EX** also provides the status of the session to the Windows LUA application.  
 ...
 An [SLI_OPEN](../core/sli-open.md) request must complete before SLI_RECEIVE_EX can be issued. However, if SLI_OPEN is issued with lua_init_type set to LUA_INIT_TYPE_PRIM_SSCP, an SLI_RECEIVE_EX over the SSCP normal flow can be issued as soon as SLI_OPEN returns an IN_PROGRESS.  
...
-   LU normal  
 ...
 If [SLI_BID](../core/sli-bid.md) successfully completes before SLI_RECEIVE is issued, the Windows LUA interface can be instructed to reuse the last SLI_BID verbs VCB. To do this, issue SLI_RECEIVE_EX with lua_flag1.bid_enable set to 1.  
