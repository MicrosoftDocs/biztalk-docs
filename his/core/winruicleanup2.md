...
## Remarks  
 ...
 If **WinRUICleanup** is called while LUs are in session ([RUI_TERM](../core/rui-term1.md) not issued), the cleanup code should issue an **RUI_TERM** close type ABEND for the application for all open sessions.  
