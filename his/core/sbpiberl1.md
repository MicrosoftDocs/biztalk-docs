...
## Remarks  
 This function should only be used to release surplus elements from a buffer. The [sepdburl](../core/sepdburl1.md) function should be called to release the entire buffer.  
