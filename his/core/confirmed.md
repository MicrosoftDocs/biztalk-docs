 ...
 *conv_id*  
 Supplied parameter. Identifies the conversation established between the two TPs. The value of this parameter is returned by [ALLOCATE](../core/allocate.md) in the invoking TP or by **RECEIVE_ALLOCATE** in the invoked TP.  
...
-   [PREPARE_TO_RECEIVE](../core/prepare-to-receive.md) if **ptr_type** is set to AP_SYNC_LEVEL and the conversation's synchronization level (established by [ALLOCATE](../core/allocate.md)) is AP_CONFIRM_SYNC_LEVEL  
  
-   [DEALLOCATE](../core/deallocate.md) if **dealloc_type** is set to AP_SYNC_LEVEL and the conversation's synchronization level (established by **ALLOCATE**) is AP_CONFIRM_SYNC_LEVEL  
  
-   [SEND_DATA](../core/send-data.md) if type is set to AP_SEND_DATA_CONFIRM and the conversation's synchronization level (established by **ALLOCATE**) is AP_CONFIRM_SYNC_LEVEL  
