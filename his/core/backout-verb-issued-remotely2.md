...
8.  When the verb completes with the **what_rcvd** field of the VCB set to AP_CONFIRM, the vendor API issues a [CONFIRMED](../HIS2010/confirmed2.md) or [MC_CONFIRMED](../HIS2010/mc-confirmed2.md) verb to acknowledge the **BACKOUT** verb.  
