...
1.  Create a Host File project and application in Visual Studio.  
     ...
     For more information about how to create a Host File application in Visual Studio, see [Creating an Application with the Managed Data Provider for Host Files](../core/creating-an-application-with-the-managed-data-provider-for-host-files1.md).  
