...
4.  In the Connection tab, configure the network, authentication, and system information. For more information, see [Data Links (Host Files)](../core/data-links-host-files.md).  
