...
## In This Section  
 [Request Reject (Category X'08')](../core/request-reject-category-x-08.md)  
  
 [Request Errors (Category X'10')](../core/request-errors-category-x-10.md)  
  
 [State Errors (Category X'20')](../core/state-errors-category-x-20.md)  
  
 [RH Usage Errors (Category X'40')](../core/rh-usage-errors-category-x-40.md)  
  
 [Path Errors (Category X'80')](../core/path-errors-category-x-80.md)  
  
 [LUSTAT Sense Codes](../core/lustat-sense-codes.md)  
  
 [Sense Data Specific to LU 6.2](../core/sense-data-specific-to-lu-6-2.md)