...
## Return Codes  
 ...
 Secondary return code; a previously issued [COPY_TRACE_TO_FILE](../core/copy-trace-to-file2.md) is still in progress. Traces cannot be active while using **DEFINE_TRACE**.  
