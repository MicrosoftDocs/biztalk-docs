...
-   The partner transaction program (TP) issued [MC_DEALLOCATE](../HIS2010/mc-deallocate1.md) with **dealloc_type** set to AP_ABEND.  
...
## 0007  
 ...
 The conversation has been deallocated because the partner TP issued [DEALLOCATE](../HIS2010/deallocate1.md) with **dealloc_type** set to AP_ABEND_SVC.  
  
## 0008  
 AP_DEALLOC_ABEND_TIMER (for a basic conversation)  
 The conversation has been deallocated because the partner TP issued [DEALLOCATE](../HIS2010/deallocate1.md) with **dealloc_type** set to AP_ABEND_TIMER.  
...
-   [SEND_ERROR](../HIS2010/send-error1.md) with **err_type** set to AP_PROG  
...
## 0011  
 ...
 While in SEND state, the partner TP (or partner LU) issued [SEND_ERROR](../HIS2010/send-error1.md) with **err_type** set to AP_SVC. Data was not truncated.  
  
## 0012  
 AP_PROG_ERROR_TRUNC/AP_SVC_ERROR_TRUNC  
 In SEND state, after sending an incomplete logical record, the partner TP issued [SEND_ERROR](../HIS2010/send-error1.md). The local TP may have received the first part of the logical record.  
  
## 0013  
 AP_SVC_ERROR_PURGING  
 The partner TP (or partner LU) issued [SEND_ERROR](../HIS2010/send-error1.md) with **err_type** set to AP_SVC while in RECEIVE, PENDING_POST, CONFIRM, CONFIRM_SEND, or CONFIRM_DEALLOCATE state. Data sent to the partner TP may have been purged.  
...
## 0017  
 ...
 APPC is currently processing a [CNOS](../HIS2010/cnos1.md) verb issued by a local LU.  
  
## 0018  
 AP_CNOS_PARTNER_LU_REJECT  
 The partner LU rejected a [CNOS](../HIS2010/cnos1.md) request from the local LU.  
...
## 0021  
 AP_CANCELED  
 The local TP issued one of the following verbs, which canceled [RECEIVE_AND_POST](../HIS2010/receive-and-post2.md) or [MC_RECEIVE_AND_POST](../HIS2010/mc-receive-and-post1.md):  
