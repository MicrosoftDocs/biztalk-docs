...
|**srcl**|CHAR|Source locality. For details, see [LPI Addresses](../HIS2010/lpi-addresses2.md).|  
|**srcp**|CHAR|Source partner. For details, see [LPI Addresses](../HIS2010/lpi-addresses2.md).|  
|**srci**|INTEGER|Source index. For details, see [LPI Addresses](../HIS2010/lpi-addresses2.md).|  
|**destl**|CHAR|Destination locality. For details, see [LPI Addresses](../HIS2010/lpi-addresses2.md).|  
|**destp**|CHAR|Destination partner. For details, see [LPI Addresses](../HIS2010/lpi-addresses2.md).|  
|**desti**|INTEGER|Destination index. For details, see [LPI Addresses](../HIS2010/lpi-addresses2.md).|  
