---
title: "Set_Sync_Level (CPI-C)2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 697b75e2-264b-4ea0-a3a7-93c9ccfa6e9e
caps.latest.revision: 3
---
# Set_Sync_Level (CPI-C)
The **Set_Sync_Level** call (function name **cmssl**) is issued by the invoking program to specify the synchronization level of the conversation. The synchronization level determines whether the programs synchronize their processing through the [Confirm](../HIS2010/confirm-cpi-c-1.md) and [Confirmed](../HIS2010/confirmed-cpi-c-1.md) calls.  
  
 This call overrides the synchronization level established by the [Initialize_Conversation](../HIS2010/initialize-conversation-cpi-c-2.md) call. The default synchronization level is CM_NONE, indicating no synchronization. This call cannot be issued after the [Allocate](../HIS2010/allocate-cpi-c-1.md) call has been issued.  
