---
title: "RUI_TERM1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 80b04a5f-b127-4a3c-9624-699eb836da48
 ...
 *LUA_PARAMETER_CHECK*  
 ...
 Secondary return code; [RUI_INIT](../HIS2010/rui-init2.md) has not yet completed successfully for the LU name specified on **RUI_TERM**.  
...
## Remarks  
 This verb can be issued at any time after [RUI_INIT](../HIS2010/rui-init2.md) has been issued (whether or not it has completed). If any other LUA verb is pending when **RUI_TERM** is issued, no further processing on the pending verb takes place, and it returns with a primary return code of LUA_CANCELED.  
