...
-   AP_YES indicates that the partner TP has issued [REQUEST_TO_SEND](../HIS2010/request-to-send2.md), which requests that the local TP change the conversation to RECEIVE state. To change to RECEIVE state, the local TP can use [PREPARE_TO_RECEIVE](../HIS2010/prepare-to-receive1.md), [RECEIVE_AND_WAIT](../HIS2010/receive-and-wait1.md), or [RECEIVE_AND_POST](../HIS2010/receive-and-post2.md).  
 ...
 *type*  
 Supplied parameter. Allows a TP to send data and perform other functions within one API call. For example, you can combine **SEND_DATA** with **type** set to CONFIRM to accomplish the same objective as issuing **SEND_DATA** followed by [CONFIRM](../HIS2010/confirm1.md).  
  
-   AP_SEND_DATA_CONFIRM corresponds to **SEND_DATA** followed by **CONFIRM**.  
  
-   AP_SEND_DATA_FLUSH corresponds to **SEND_DATA** followed by [FLUSH](../HIS2010/flush1.md).  
  
-   AP_SEND_DATA_DEALLOC_ABEND corresponds to **SEND_DATA** followed by [DEALLOCATE](../HIS2010/deallocate1.md) with a **dealloc_type** of AP_ABEND_PROG.  
...
-   AP_SEND_DATA_P_TO_R_FLUSH corresponds to **SEND_DATA** followed by [PREPARE_TO_RECEIVE](../HIS2010/prepare-to-receive1.md) with a **ptr_type** of AP_FLUSH.  
...
-   The local TP issues [FLUSH](../HIS2010/flush1.md), [CONFIRM](../HIS2010/confirm1.md), or [DEALLOCATE](../HIS2010/deallocate1.md) (or other verb that flushes the LU's send buffer).