...
1.  Establish a connection using `HostFileConnection`.  
     ...
     For more information, see [How to Connect to and Disconnect from a Host File System](../HIS2010/how-to-connect-to-and-disconnect-from-a-host-file-system1.md).  
