...
-   [Protect the MSHIS60_HIP Database and SQL Server Stored Procedures](../HIS2010/protect-the-mshis60-hip-database-and-sql-server-stored-procedures2.md)  
  
-   [Protect the COM+ and .NET Servers](../HIS2010/protect-the-net-servers2.md)  
  
-   [Protect the Raw User Data](../HIS2010/protect-the-raw-user-data2.md)  
  
-   [Protect the HIP Listener](../HIS2010/protect-the-hip-listener1.md)  
  
-   [Protect the Local File System, Database, and Registry](../HIS2010/protect-the-local-file-system-database-and-registry2.md)  
  
-   [Protect the Client Proxy](../HIS2010/protect-the-client-proxy2.md)  
  
-   [Protect the Remoting Session](../HIS2010/protect-the-remoting-session2.md)  
  
-   [Protect TI from Unauthorized Mainframe or AS/400 Access](../HIS2010/protect-ti-from-unauthorized-mainframe-or-as-400-access2.md)  
  
-   [Protect the TI Runtime Environment](../HIS2010/protect-the-ti-runtime-environment2.md)  
  
-   [Protect Mainframe Security Credentials from Being Overridden](../HIS2010/protect-mainframe-security-credentials-from-being-overridden2.md)  
  
-   [Protect the TI Runtime and Host Environments from Data Overflows](../HIS2010/protect-the-ti-runtime-and-host-environments-from-data-overflows1.md)  
