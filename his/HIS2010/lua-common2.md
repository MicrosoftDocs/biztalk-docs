 ...
 *lua_resv56*  
 Supplied parameter. Reserved field used by [SLI_OPEN](../HIS2010/sli-open1.md) and [RUI_INIT](../HIS2010/rui-init2.md). For all other LUA verbs, this parameter is reserved and should be set to zero.  
