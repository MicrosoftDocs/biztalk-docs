...
## Remarks  
 ...
 It is possible to add an element to an existing buffer by calling [sbpibegt](../HIS2010/sbpibegt1.md) to get the extra element. The new element should be added to the element chain of the buffer, and the "number of elements" count should be updated.  
