...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 14d7555e-3b9e-48c1-8925-4d134a6e2e23
caps.latest.revision: 4
---
# DISPLAY
The **DISPLAY** verb returns configuration information and current operating values for the SNA node.  
  
 It is recommended that you use the [GetAppcConfig](../HIS2010/getappcconfig2.md) Windows extension function to obtain system configuration information relating to APPC LUs. Users of 5250 emulators, in particular, should use the **GetAPPCConfig** Windows extension.  
...
## See Also  
 [Host Integration Server Extensions](../HIS2010/host-integration-server-extensions2.md)   
 [Differences by Information Type](../HIS2010/differences-by-information-type2.md)