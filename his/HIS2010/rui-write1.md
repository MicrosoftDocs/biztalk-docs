---
title: "RUI_WRITE1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: cd90a123-4e1b-47ef-8d81-b2523d407375
...
## Return Codes  
 ...
 Secondary return code; the verb was canceled because [RUI_TERM](../HIS2010/rui-term1.md) was issued for this session.  
...
## Remarks  
 [RUI_INIT](../HIS2010/rui-init2.md) must be issued successfully before this verb is issued.  
 ...
 **RUI_WRITE** can be issued on the SSCP normal flow at any time after a successful [RUI_INIT](../HIS2010/rui-init2.md). **RUI_WRITE** verbs on the LU expedited or LU normal flows are permitted only after a BIND has been received, and must abide by the protocols specified on the BIND.  
