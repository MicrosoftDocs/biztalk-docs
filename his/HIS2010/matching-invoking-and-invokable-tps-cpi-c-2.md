...
-   The comparison of requested and available TP names is carried out in a specific order:  
 ...
 For suggestions about specific ways to handle TP names and LU aliases, see [Arranging TPs Within an SNA Network](../HIS2010/arranging-tps-within-an-sna-network-cpi-c-1.md).  
