...
## 00000031  
 ...
 The local TP attempted to use [CONFIRM](../HIS2010/confirm1.md) or [MC_CONFIRM](../HIS2010/mc-confirm1.md) in a conversation with a synchronization level of AP_NONE. The synchronization level, established by [ALLOCATE](../HIS2010/allocate1.md) or [MC_ALLOCATE](../HIS2010/mc-allocate1.md), must be AP_CONFIRM_SYNC_LEVEL.  
...
## 000000F2  
 ...
 The local TP issued [SEND_DATA](../HIS2010/send-data2.md) or [MC_SEND_DATA](../HIS2010/mc-send-data2.md), but the conversation was not in SEND state.  
...
## 00000152  
 ...
 On the [CNOS](../HIS2010/cnos1.md) verb, the value for **auto_activate** is greater than the value for **partner_lu_mode_session_limit**.  
...
## 0000015A  
 ...
 For a single-session [CNOS](../HIS2010/cnos1.md) verb, APPC permits only the local (source) LU to be responsible for deactivating sessions.  
...
## 0000015C  
 ...
 Your program issued a [CNOS](../HIS2010/cnos1.md) verb, specifying a **partner_lu_mode_session_limit** number and **set_negotiable** (NO).  
...
## 0000015E  
 AP_LU_DETACHED  
 A command reset the definition of the local LU before the [CNOS](../HIS2010/cnos1.md) verb tried to specify the LU.  
  
## 0000015F  
 AP_CNOS_COMMAND_RACE_REJECT  
 The local LU is currently processing a [CNOS](../HIS2010/cnos1.md) verb issued by the partner LU.  
  
## 00000167  
 AP_SNASVCMG_RESET_NOT_ALLOWED  
 Your local program attempted to issue the [CNOS](../HIS2010/cnos1.md) verbs for the mode named SNASVCMG, specifying a session limit of zero.  
  
## 000001B4  
 AP_DISPLAY_INFO_EXCEEDS_LENGTH  
 The returned [DISPLAY](../HIS2010/display1.md) information did not fit in the buffer.  
...
## 00000509  
 ...
 APPC did not find an incoming allocate (from the invoking TP) to match the value of **tp_name**, supplied by [RECEIVE_ALLOCATE](../HIS2010/receive-allocate2.md). **RECEIVE_ALLOCATE** waited for the incoming allocate and eventually timed out.  
...
## 00000525  
 AP_INVALID_PROCESS  
 The process issuing [RECEIVE_ALLOCATE](../HIS2010/receive-allocate2.md) was different from the one started by APPC.  
