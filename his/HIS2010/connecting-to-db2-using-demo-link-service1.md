---
title: "Connecting to DB2 using Demo Link Service1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 9e6af007-a031-46de-8530-763179c710c8
...
-   [Configuring a Demo SNA Connection for DB2](../HIS2010/connecting-to-db2-using-demo-link-service1.md#sna)  
  
-   [Configuring a Demo Data Source for DB2](../HIS2010/connecting-to-db2-using-demo-link-service1.md#ds)  
...
1.  Click **Start**, **Programs**, **Microsoft Host Integration Server 2010**, and then click **SNA Manager**.   
...
1.  Click **Start**, **Programs**, **Microsoft Host Integration Server 2010**, and then click **Data Access Tool**. The Data Access Tool appears.  
...
14. Click **Finish**.  The Data Access Tool displays the DRDADEMO connection in the DB2 OLE DB UDLs folder.  
 ...
 The Data Integration Samples in the SDK include a pre-configured UDL file for use with the DRDADEMO demo link service and connection. See C:\Program Files\Microsoft Host Integration Server 2010\SDK\Samples\DataIntegration\DRDADEMO.UDL.  
