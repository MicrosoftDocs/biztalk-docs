---
title: "Close(PLU) Request1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 4e05906f-0540-4240-93b4-edfcc09a72af
...
-   If the application is using the LUA variant of the function management interface (FMI), and the **Close(PLU) Request** was generated by receipt of an **UNBIND** from the host, the element is included, and **startd** points to the TH of the **UNBIND** message. (For more information about FMI, see [FMI Concepts](../HIS2010/fmi-concepts2.md).)  
