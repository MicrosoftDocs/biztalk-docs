...
## Return Codes  
 CM_OK  
 Primary return code; the call executed successfully. The partner program issued the [Confirmed](../HIS2010/confirmed-cpi-c-1.md) call.  
...
## Remarks  
 In response to **Confirm**, the partner program normally issues [Confirmed](../HIS2010/confirmed-cpi-c-1.md) to confirm that it has received the data without error. (If the partner program encounters an error, it issues [Send_Error](../HIS2010/send-error-cpi-c-1.md) or uses [Deallocate](../HIS2010/deallocate-cpi-c-2.md) to abnormally deallocate the conversation.)  
