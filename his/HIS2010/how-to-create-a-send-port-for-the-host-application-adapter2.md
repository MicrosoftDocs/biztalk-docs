...
6.  Configure the following properties:  
    ...
    |**Connection String**|Used to the define assembly and connection string mappings to be used by the runtime to location the assembly and create an RE.  For more information, see [BizTalk Adapter for Host Applications](../HIS2010/biztalk-adapter-for-host-applications1.md).|  
...
## See Also  
 [Configuring BizTalk Adapter for Host Applications](../HIS2010/configuring-biztalk-adapter-for-host-applications2.md)   
