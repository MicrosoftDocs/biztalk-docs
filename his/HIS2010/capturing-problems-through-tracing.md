 ...
 **Data provider tracing using Provider Trace Utility**  
 ...
 The HIS Trace Utility captures and saves information from the Microsoft network client connections, provider interfaces and data messages. For more information, see [Trace Utility Help](../HIS2010/trace-utility-help2.md) and [SNA Trace Utility](../HIS2010/sna-trace-utility2.md).  
