...
The current APPC implementation in Host Integration Server supports conversations with **synclevel** of AP_NONE, AP_CONFIRM_SYNC_LEVEL, or AP_SYNCPT. The [DEALLOCATE](../HIS2010/deallocate1.md), [MC_DEALLOCATE](../HIS2010/mc-deallocate1.md), [PREPARE_TO_RECEIVE](../HIS2010/prepare-to-receive1.md), and [MC_PREPARE_TO_RECEIVE](../HIS2010/mc-prepare-to-receive2.md) verbs specify a **type** member indicating the synchronization level required. This parameter is interpreted as follows:  
  
|Allocated synclevel|Type specified|Action performed|  
|-------------------------|--------------------|----------------------|  
|AP_NONE|AP_FLUSH|Action of [FLUSH](../HIS2010/flush1.md) or [MC_FLUSH](../HIS2010/mc-flush2.md) verb before deallocation or change of direction.|  
|AP_NONE|AP_SYNCLEVEL|Action of **FLUSH** or **MC_FLUSH** verb before deallocation or change of direction.|  
|AP_SYNCPT|AP_FLUSH|Action of [FLUSH](../HIS2010/flush1.md) or [MC_FLUSH](../HIS2010/mc-flush2.md) verb before deallocation or change of direction.|  
|AP_SYNCPT or  AP_CONFIRM_SYNC_LEVEL|AP_CONFIRM_TYPE|Action of [CONFIRM](../HIS2010/confirm1.md) or [MC_CONFIRM](../HIS2010/mc-confirm1.md) verb before deallocation or change of direction.|  
...
-   Intercept [DEALLOCATE](../HIS2010/deallocate1.md), [MC_DEALLOCATE](../HIS2010/mc-deallocate1.md), [PREPARE_TO_RECEIVE](../HIS2010/prepare-to-receive1.md), and [MC_PREPARE_TO_RECEIVE](../HIS2010/mc-prepare-to-receive2.md) verbs on Sync Point Level 2 conversations when type AP_SYNCLEVEL is specified for **synclevel**.  
...
-   On completion of the verb, issue the original **DEALLOCATE**, **MC_DEALLOCATE**, **PREPARE_TO_RECEIVE**, or **MC_PREPARE_TO_RECEIVE** verb to [!INCLUDE[hishostintegrationserver2009](../includes/hishostintegrationserver2009-md.md)].  
 ...
 The [DEALLOCATE](../HIS2010/deallocate1.md), [MC_DEALLOCATE](../HIS2010/mc-deallocate1.md), [PREPARE_TO_RECEIVE](../HIS2010/prepare-to-receive1.md), and [MC_PREPARE_TO_RECEIVE](../HIS2010/mc-prepare-to-receive2.md) verbs specify a type member indicating the synchronization level required. This parameter is interpreted as follows:  
...
|AP_CONFIRM_SYNC_LEVEL|AP_SYNCLEVEL|Action of [CONFIRM](../HIS2010/confirm1.md) or [MC_CONFIRM](../HIS2010/mc-confirm1.md) verb before deallocation or change of direction.|