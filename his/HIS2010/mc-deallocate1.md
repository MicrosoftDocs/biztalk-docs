---
title: "MC_DEALLOCATE1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 65b4ef3c-a0e0-4f7f-9c81-0c244b5fa046
 ...
 *tp_id*  
 Supplied parameter. Identifies the local TP. The value of this parameter was returned by [TP_STARTED](../HIS2010/tp-started1.md) in the invoking TP or by [RECEIVE_ALLOCATE](../HIS2010/receive-allocate2.md) in the invoked TP.  
  
 *conv_id*  
 Supplied parameter. Identifies the conversation established between the two TPs. The value of this parameter is returned by [MC_ALLOCATE](../HIS2010/mc-allocate1.md) in the invoking TP or by **RECEIVE_ALLOCATE** in the invoked TP.  
 ...
 *dealloc_type*  
 ...
 AP_SYNC_LEVEL uses the conversation's synchronization level (established by [MC_ALLOCATE](../HIS2010/mc-allocate1.md)) to determine how to deallocate the conversation. This value is allowed only if the conversation is in SEND state.  
...
-   [MC_FLUSH](../HIS2010/mc-flush2.md), by sending the contents of the local LU's send buffer to the partner LU (and TP).  
  
-   [MC_CONFIRM](../HIS2010/mc-confirm1.md), by sending the contents of the local LU's send buffer and a confirmation request to the partner TP.  
