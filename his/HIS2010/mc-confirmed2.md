---
title: "MC_CONFIRMED2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 5d1e4ddd-ec52-4bbf-9b4a-913920a62fcf
...
-   [MC_PREPARE_TO_RECEIVE](../HIS2010/mc-prepare-to-receive2.md) if **ptr_type** is set to AP_SYNC_LEVEL and the conversation's synchronization level (established by [MC_ALLOCATE](../HIS2010/mc-allocate1.md)) is AP_CONFIRM_SYNC_LEVEL  
  
-   [MC_DEALLOCATE](../HIS2010/mc-deallocate1.md) if **dealloc_type** is set to AP_SYNC_LEVEL and the conversation's synchronization level (established by MC_ALLOCATE) is AP_CONFIRM_SYNC_LEVEL  
  
-   [MC_SEND_DATA](../HIS2010/mc-send-data2.md) if type is set to AP_SEND_DATA_CONFIRM and the conversation's synchronization level (established by MC_ALLOCATE) is AP_CONFIRM_SYNC_LEVEL  
