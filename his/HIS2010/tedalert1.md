---
title: "Tedalert1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: d88ce059-5842-4c88-bd0a-d02f2cf73fe3
...
## Remarks  
 ...
 Note that the application should determine whether the user is permitted to send NetView user alerts and/or view RTM data (see [3270 User Record Format](../HIS2010/3270-user-record-format1.md)). It should not display the appropriate information, as described below, if the user does not have permission to use that information. The host can also override whether the application is permitted to send and/or to display RTM data (for more information, see [RTM Parameters](../HIS2010/rtm-parameters]1.md)).  
  
 For more information about how the application uses the RTM parameters, see [RTM Parameters](../HIS2010/rtm-parameters]1.md), [Response Time Monitor Data](../HIS2010/response-time-monitor-data2.md), and [Status-RTM](../HIS2010/status-rtm2.md).  
