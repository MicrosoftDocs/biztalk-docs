...
-   Contain information returned by the verb when execution is complete.  
 ...
 The VCB structure is declared in the WINLUA.H header file. For general VCB information, see [LUA VCB Format](../HIS2010/lua-vcb-format2.md). For verb-specific VCB information, see the reference documentation for each verb.