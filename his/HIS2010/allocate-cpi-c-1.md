...
#### Parameters  
 *conversation_ID*  
 Supplied parameter. Specifies the conversation identifier. The value of this parameter was returned by [Initialize_Conversation](../HIS2010/initialize-conversation-cpi-c-2.md).  
...
-   The mode name derived from the side information or set by [Set_Mode_Name](../HIS2010/set-mode-name-cpi-c-1.md) is not valid.  
...
-   The partner LU name derived from the side information or set by [Set_Partner_LU_Name](../HIS2010/set-partner-lu-name-cpi-c-1.md) is not valid.  
...
-   Password  
 ...
 To send the allocation request immediately, the invoking program can issue [Flush](../HIS2010/flush-cpi-c-1.md) or [Confirm](../HIS2010/confirm-cpi-c-1.md) immediately after **Allocate**. Otherwise, the allocate request accumulates with other data in the local LUs send buffer until the buffer is full.  
