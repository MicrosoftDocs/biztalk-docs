...
-   A resource identifier that can be used by the application to correlate the [Open(PLU) Request](../HIS2010/open-plu-request1.md) that is sent to the application. (For more information, see [Opening the PLU Connection](../HIS2010/opening-the-plu-connection2.md).)  
...
-   An indicator that specifies whether the application is an LUA. This determines whether the local node and the application will communicate using the LUA variant of the function management interface (FMI). (For more information, see [FMI Concepts](../HIS2010/fmi-concepts2.md).)  
