---
title: "Set_Fill (CPI-C)2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 9eb2c097-02fa-4c5d-a46d-9a225e869dc8
 ...
 *fill*  
 ...
 CM_FILL_LL  
 Data is received in logical-record format. The data received can be a complete logical record, a portion of a logical record equal to the *requested_length* parameter of the [Receive](../HIS2010/receive-cpi-c-1.md) call, or the end of a logical record.  
...
## Remarks  
 **Set_Fill** overrides the default *fill* established by [Initialize_Conversation](../HIS2010/initialize-conversation-cpi-c-2.md) or [Accept_Conversation](../HIS2010/accept-conversation-cpi-c-1.md). The default *fill* is CM_FILL_LL.  
  
 The *fill* value affects all subsequent [Receive](../HIS2010/receive-cpi-c-1.md) calls. It can be changed by reissuing the **Set_Fill** call.