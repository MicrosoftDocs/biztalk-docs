---
title: "Specify_Windows_Handle (CPI-C)1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 8a2c4d4e-d962-4b41-9808-616652fef253
...
## Remarks  
 An application can set the processing mode by calling [Set_Processing_Mode](../HIS2010/set-processing-mode-cpi-c-1.md). If the Windows handle is set to NULL, or this call is never issued, the application must call [Wait_For_Conversation](../HIS2010/wait-for-conversation-cpi-c-2.md) to be notified when the outstanding operation completes.  
