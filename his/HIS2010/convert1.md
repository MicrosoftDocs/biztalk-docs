...
> [!NOTE]
>  You can use [GET_CP_CONVERT_TABLE](../HIS2010/get-cp-convert-table2.md) to build a type G user-written conversion table in memory, and then store the table in a file.