...
-   If an outage has been reported by the SNALink.  
 ...
 The case of multipoint connections is slightly different and is considered in [SDLC Multipoint Connections](../HIS2010/sdlc-multipoint-connections2.md). The following topics discuss point-to-point connections.  
...
-   [Outages](../HIS2010/outages-snadis-1.md)  
  
-   [Connection Retries](../HIS2010/connection-retries-snadis-2.md)