...
-   Fields that occupy two bytes, such as **opresid** in the [Open(PLU) Request](../HIS2010/open-plu-request1.md), are represented with the most arithmetically significant byte in the lowest byte address, irrespective of the normal orientation used by the processor on which the software executes. That is, the 2-byte value 0x1234 has the byte 0x12 in the lowest byte address. However, the following fields are exceptions:  
...
-   Applications must assign unique index (I) values for every active LPI connection within the node. In particular, the [Open(SSCP) Request](../HIS2010/open-sscp-request1.md) must be different from the source index it sends in response to the [Open(PLU)](../HIS2010/open-plu-2.md). Additionally, zero should not be used as an I value. An I value of zero means that the sender of the message is inviting the recipient of the message to assign an I value.  
...
-   Note that where a buffer element has a **startd** of 1, 10, or 13, this only applies to the initial element in the chain of elements, and subsequent elements in the chain have a **startd** of 1. Messages with two distinct linked element chains in the message formats (for example [Open(PLU) Request](../HIS2010/open-plu-request1.md) and [Open(PLU) OK Response](../HIS2010/open-plu-oresponse1.md)) have the **startd** field in the elements at the start of the chains as the value (1, 10, or 13) given in the message format, and the **startd** fields in all other elements as 1.  
  
## In This Section  
  
-   [Open(SSCP)](../HIS2010/open-sscp-1.md)  
  
-   [Open(SSCP) Request](../HIS2010/open-sscp-request1.md)  
  
-   [Open(SSCP) Response](../HIS2010/open-sscp-response2.md)  
  
-   [Open(PLU)](../HIS2010/open-plu-2.md)  
  
-   [Open(PLU) Request](../HIS2010/open-plu-request1.md)  
  
-   [Open(PLU) OK Response](../HIS2010/open-plu-oresponse1.md)  
  
-   [Open(PLU) Error Response](../HIS2010/open-plu-error-response1.md)  
  
-   [Open(PLU) OK Confirm](../HIS2010/open-plu-oconfirm2.md)  
  
-   [Open(PLU) Error Confirm](../HIS2010/open-plu-error-confirm1.md)  
  
-   [Close(SSCP)](../HIS2010/close-sscp-1.md)  
  
-   [Close(SSCP) Request](../HIS2010/close-sscp-request1.md)  
  
-   [Close(SSCP) Response](../HIS2010/close-sscp-response2.md)  
  
-   [Close(PLU)](../HIS2010/close-plu-1.md)  
  
-   [Close(PLU) Request](../HIS2010/close-plu-request1.md)  
  
-   [Close(PLU) Response](../HIS2010/close-plu-response1.md)  
  
-   [Data](../HIS2010/data2.md)  
  
-   [Status-Acknowledge](../HIS2010/status-acknowledge2.md)  
  
-   [Status-Acknowledge(Ack)](../HIS2010/status-acknowledge-ack-1.md)  
  
-   [Status-Acknowledge(Nack-1)](../HIS2010/status-acknowledge-nack-1-2.md)  
  
-   [Status-Acknowledge(Nack-2)](../HIS2010/status-acknowledge-nack-2-1.md)  
  
-   [Status-Acknowledge(ACKLUA)](../HIS2010/status-acknowledge-acklua-1.md)  
  
-   [Status-Control](../HIS2010/status-control2.md)  
  
-   [Status-Control(...) Request](../HIS2010/status-control-request1.md)  
  
-   [Status-Control(...) Acknowledge](../HIS2010/status-control-acknowledge2.md)  
  
-   [Status-Control(...) Negative-Acknowledge-1](../HIS2010/status-control-negative-acknowledge-12.md)  
  
-   [Status-Control(...) Negative-Acknowledge-2](../HIS2010/status-control-negative-acknowledge-22.md)  
  
-   [Status-Control(...) ACKLUA](../HIS2010/status-control-acklua2.md)  
  
-   [Status-Error](../HIS2010/status-error2.md)  
  
-   [Status-Resource](../HIS2010/status-resource2.md)  
  
-   [Status-RTM](../HIS2010/status-rtm2.md)  
  
-   [Status-Session](../HIS2010/status-session1.md)