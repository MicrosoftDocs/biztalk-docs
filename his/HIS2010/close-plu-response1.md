---
title: "Close(PLU) Response1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: e2ef3a53-eadd-4ba0-aa7c-d62732528354
...
-   The **Close(PLU)** protocol is unconditional. It is not possible for the recipient of a [Close(PLU) Request](../HIS2010/close-plu-request1.md) (either the local node or an application) to keep the PLU connection open. The only valid response is **Close(PLU) Response** with the close qualifier as RSPOK.