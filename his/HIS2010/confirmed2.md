---
title: "CONFIRMED2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 3a32b55e-ceaf-46a5-b3be-326565512abc
...
-   [PREPARE_TO_RECEIVE](../HIS2010/prepare-to-receive1.md) if **ptr_type** is set to AP_SYNC_LEVEL and the conversation's synchronization level (established by [ALLOCATE](../HIS2010/allocate1.md)) is AP_CONFIRM_SYNC_LEVEL  
  
-   [DEALLOCATE](../HIS2010/deallocate1.md) if **dealloc_type** is set to AP_SYNC_LEVEL and the conversation's synchronization level (established by **ALLOCATE**) is AP_CONFIRM_SYNC_LEVEL  
  
-   [SEND_DATA](../HIS2010/send-data2.md) if type is set to AP_SEND_DATA_CONFIRM and the conversation's synchronization level (established by **ALLOCATE**) is AP_CONFIRM_SYNC_LEVEL  
