---
title: "External Data Sources (Excel)2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 3c51ab43-bf64-4076-bcf4-ef4a640f62eb
...
## Excel and the OLE DB Provider for AS/400 and VSAM  
...
4.  In the Connection tab, configure the network, authentication, and system information. For more information, see [Data Links (Host Files)](../HIS2010/data-links-host-files.md).  
