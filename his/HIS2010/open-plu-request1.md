---
title: "Open(PLU) Request1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: c1308f25-6d82-4324-b443-3fad76aecdc4
...
-   The LU number matches that allocated to the named application on the [Open(SSCP) Response](../HIS2010/open-sscp-response2.md).  
  
-   The resource identifier matches the value used by the application on the [Open(SSCP) Request](../HIS2010/open-sscp-request1.md).  
