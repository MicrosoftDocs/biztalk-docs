---
title: "DEALLOCATE1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 5be8998e-091d-4368-9984-967eaf2316f2
 ...
 *conv_id*  
 Supplied parameter. Identifies the conversation established between the two TPs. The value of this parameter is returned by [ALLOCATE](../HIS2010/allocate1.md) in the invoking TP or by **RECEIVE_ALLOCATE** in the invoked TP.  
...
-   AP_ABEND_TIMER  
 ...
 AP_SYNC_LEVEL uses the conversation's synchronization level (established by [ALLOCATE](../HIS2010/allocate1.md)) to determine how to deallocate the conversation. This value is allowed only if the conversation is in SEND state.  
...
-   [FLUSH](../HIS2010/flush1.md), by sending the contents of the local LU's send buffer to the partner LU (and TP).  
  
-   [CONFIRM](../HIS2010/confirm1.md), by sending the contents of the local LU's send buffer and a confirmation request to the partner TP.  
...
-   If the session is terminated abnormally due to a DLC outage.  
 ...
 [!INCLUDE[hishostintegrationserver2009](../includes/hishostintegrationserver2009-md.md)] allows TPs to deallocate conversations immediately after sending data by specifying the **type** parameter on [SEND_DATA](../HIS2010/send-data2.md) as AP_SEND_DATA_DEALLOC_\*. However, the SEND_DATA verbs do not contain the implied forget callback function. TPs that want to receive implied forget notification must issue **DEALLOCATE** explicitly.