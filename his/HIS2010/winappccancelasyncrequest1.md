...
The **WinAPPCCancelAsyncRequest** function cancels an outstanding [WinAsyncAPPC](../HIS2010/winasyncappc2.md)-based request.  
...
## Remarks  
 ...
 If the outstanding verb relates to a conversation (for example, [SEND_DATA](../HIS2010/send-data2.md) or [RECEIVE_AND_WAIT](../HIS2010/receive-and-wait1.md)), the verb is purged and the session is closed. If the verb relates to a TP (for example, [RECEIVE_ALLOCATE](../HIS2010/receive-allocate2.md) or [TP_STARTED](../HIS2010/tp-started1.md)), the TP is ended. In both cases, while the implementation closes conversations and sessions as cleanly as possible, it does not flush send buffers, wait for confirmations, and so on. This call is synchronous, and after the processing described above is complete, a completion message is posted for the canceled verb.  
