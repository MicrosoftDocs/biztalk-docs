---
title: "SNA Service1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: a1aff04e-abea-4617-9e3e-e4c3bd51ca7b
...
## In This Section  
 [Communication Between Host Integration Server Computers and a Host Computer](../HIS2010/communication-between-host-integration-server-computers-and-a-host-computer1.md).  
  
 [Communication Between Multiple Host Integration Server Computers](../HIS2010/communication-between-multiple-host-integration-server-computers2.md).  
  
 [Communication Between Host Integration Server Computers and Client Computers](../HIS2010/communication-between-host-integration-server-computers-and-client-computers2.md).