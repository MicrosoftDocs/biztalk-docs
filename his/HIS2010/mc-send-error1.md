 ...
 *rts_rcvd*  
 Returned parameter. Indicates whether the partner TP issued [MC_REQUEST_TO_SEND](../HIS2010/mc-request-to-send2.md).Possible values include:  
  
-   AP_YES indicates that the partner TP has issued **MC_REQUEST_TO_SEND**, which requests that the local TP change the conversation to RECEIVE state. To change to RECEIVE state, the local TP can use [MC_PREPARE_TO_RECEIVE](../HIS2010/mc-prepare-to-receive2.md), [MC_RECEIVE_AND_WAIT](../HIS2010/mc-receive-and-wait1.md), or [MC_RECEIVE_AND_POST](../HIS2010/mc-receive-and-post1.md).  
...
-   The partner TP encountered an ABEND, causing the partner LU to send an **MC_DEALLOCATE** request.  
 ...
 The partner TP issued [MC_DEALLOCATE](../HIS2010/mc-deallocate1.md) with **dealloc_type** set to one of the following:  
...
-   Data sent by [MC_SEND_DATA](../HIS2010/mc-send-data2.md).  
