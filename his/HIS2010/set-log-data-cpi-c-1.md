---
title: "Set_Log_Data (CPI-C)1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: be8e82a8-e8aa-4b05-a3f5-d5fdcc655b35
...
-   [Deallocate](../HIS2010/deallocate-cpi-c-2.md) with the conversations deallocate type set to CM_DEALLOCATE_ABEND  
  
-   [Send_Data](../HIS2010/send-data-cpi-c-1.md) with the conversations send type set to CM_SEND_AND_DEALLOCATE and the deallocate type set to CM_DEALLOCATE_ABEND  
