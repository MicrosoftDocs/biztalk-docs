---
title: "Status-Session Codes2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 4ad48025-cbdb-4164-9039-29d5a85a2d7b
caps.latest.revision: 3
---
# Status-Session Codes
For the status codes used on [Status-Session](../HIS2010/status-session1.md) messages, the following table lists:  
...
-   On which sessions the combinations of primary and qualifying status codes can occur.  
 ...
 For an overall description of the role of the **Status-Session** message, see [Status-Session Message](../HIS2010/status-session-message2.md). The individual codes are discussed in [SSCP Connection](../HIS2010/sscp-connection2.md) and [PLU Connection](../HIS2010/plu-connection1.md).  
