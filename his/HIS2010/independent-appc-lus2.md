---
title: "Independent APPC LUs2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: d9f4b531-660f-44ef-912a-837ddeaacc68
...
Independent APPC LU communications with a peer system  
 ...
 Modes determine the interactions between TPs on an APPC-APPC connection. Modes can be assigned to an LU or supplied when the session is first established. For more information about modes, see [APPC Mode Definition](../HIS2010/appc-mode-definition1.md) later in this section.  
