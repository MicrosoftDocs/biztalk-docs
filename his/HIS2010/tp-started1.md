---
title: "TP_STARTED1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: d1197502-5ac8-455f-8941-db3a98975bcb
caps.latest.revision: 3
---
# TP_STARTED
The **TP_STARTED** verb is issued by the invoking transaction program (TP), and notifies APPC that the TP is starting.  
  
 For the Microsoft® Windows® version 3.*x* system, it is recommended that you use the [WinAsyncAPPC](../HIS2010/winasyncappc2.md) function rather than the blocking version of this call.  
 ...
 *lu_alias*  
 ...
 The name must match an LU alias established during configuration. APPC checks the LU alias against the current Host Integration Server configuration file. Due to the client/server architecture used by Host Integration Server, however, this parameter is not validated until an [ALLOCATE](../HIS2010/allocate1.md) or [MC_ALLOCATE](../HIS2010/mc-allocate1.md) is performed.  
...
-   Special characters $, #, % and @  
 ...
 To use an LU from the default LU pool, set this field to eight hexadecimal zeros. For more information, see [Default LUs](../HIS2010/default-lus1.md).  
...
-   [Default LUs](../HIS2010/default-lus1.md)