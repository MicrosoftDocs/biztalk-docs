...
|NumSends =|2|The number of [Send_Data](../HIS2010/send-data-cpi-c-1.md) calls per conversation.|  
|SendSize =|1024|The size of data sent each time in bytes .|  
|ConfirmEvery =|1|The number of **Send_Data** calls between [Confirm](../HIS2010/confirm-cpi-c-1.md) calls. If ConfirmEvery=0, CPICSEND will not issue CONFIRM verbs.|  
