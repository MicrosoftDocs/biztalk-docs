---
title: "Set_Processing_Mode (CPI-C)1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 2bb732a1-679c-4a8c-8d57-4f33fccd2d38
...
> [!NOTE]
>  A program is notified of the completion of nonblocking calls when it issues [Wait_For_Conversation](../HIS2010/wait-for-conversation-cpi-c-2.md) or through a Microsoft® Windows® message sent to a WndProc identified by the *hWnd* in the [Specify_Windows_Handle](../HIS2010/specify-windows-handle-cpi-c-1.md) call.  
