---
title: "Send_Data (CPI-C)1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: ca6134b2-0d13-40f7-a83f-2adec4189219
...
-   The local program issues a [Flush](../HIS2010/flush-cpi-c-1.md), [Confirm](../HIS2010/confirm-cpi-c-1.md), or [Deallocate](../HIS2010/deallocate-cpi-c-2.md) call or other call that flushes the LUs send buffer. (Some send types, set by [Set_Send_Type](../HIS2010/set-send-type-cpi-c-1.md), include flush functionality.)  
...
-   A complete logical record or portion thereof on a basic conversation. A complete logical record is determined by the LL value. (One logical record can end and a new one begin in the middle of the string of data to be sent.)  
 ...
 The LU does not automatically perform any conversion between ASCII and EBCDIC on the string of data to be sent. If necessary, the program can use the Common Service Verb (CSV) [CONVERT](../HIS2010/convert1.md) to translate a string from one character set to the other.