---
title: "SLI_SEND1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 8b5cbb46-4e28-4f0f-a2f8-e6ae7524be47
 ...
 **lua_rh**  
 Supplied parameter. Contains the SNA request/response header (RH) of the message sent or received. It is set for [RUI_WRITE](../HIS2010/rui-write1.md) and **SLI_SEND**, and returned by [RUI_READ](../HIS2010/rui-read1.md) and [RUI_BID](../HIS2010/rui-bid2.md). For the RH for **SLI_SEND**, all fields except the queued-response indicator (**lua_rh.qri**) and pacing indicator (**lua_rh.pi**) are used.  
...
## Return Codes  
 ...
 When issuing [SLI_RECEIVE](../HIS2010/sli-receive1.md), set at least one lua_flag1 flow flag.  
 ...
 Secondary return code; the application did not provide user-supplied data required by the verb issued. Note that when **SLI_SEND** is issued for an SNA LUSTAT command, status (in four bytes) is required, and that when [SLI_OPEN](../HIS2010/sli-open1.md) is issued with secondary initialization, data is required.  
 ...
 The supplied data segment for [SLI_RECEIVE](../HIS2010/sli-receive1.md) or **SLI_SEND** is not a read/write data segment as required.  
