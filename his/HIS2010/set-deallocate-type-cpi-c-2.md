---
title: "Set_Deallocate_Type (CPI-C)2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: bf8c28f4-e39c-4461-b5ce-898d673967e8
 ...
 *deallocate_type*  
 ...
 This request for deallocation confirmation is sent by [Deallocate](../HIS2010/deallocate-cpi-c-2.md) or by [Send_Data](../HIS2010/send-data-cpi-c-1.md) with the send type set to CM_SEND_AND_DEALLOCATE. The conversation is deallocated normally when the partner program issues [Confirmed](../HIS2010/confirmed-cpi-c-1.md), responding to the confirmation request.  
 ...
 Uses the conversations synchronization level to determine how to deallocate the conversation. A default synchronization level is established by [Initialize_Conversation](../HIS2010/initialize-conversation-cpi-c-2.md) and can be overridden by [Set_Sync_Level](../HIS2010/set-sync-level-cpi-c-2.md).  
 ...
 If the synchronization level of the conversation is CM_CONFIRM, the contents of the local LUs send buffer and a request to confirm the deallocation are sent to the partner program. This request for deallocation confirmation is sent by [Deallocate](../HIS2010/deallocate-cpi-c-2.md) or by [Send_Data](../HIS2010/send-data-cpi-c-1.md) with the send type set to CM_SEND_AND_DEALLOCATE. The conversation is deallocated normally when the partner program issues the [Confirmed](../HIS2010/confirmed-cpi-c-1.md) call, responding to the confirmation request.  
...
## Remarks  
 This call overrides the default deallocate type established by [Initialize_Conversation](../HIS2010/initialize-conversation-cpi-c-2.md) or [Accept_Conversation](../HIS2010/accept-conversation-cpi-c-1.md). The default deallocate type is CM_DEALLOCATE_SYNC_LEVEL.  
  
 The deallocation instructions specified by this call take effect when [Deallocate](../HIS2010/deallocate-cpi-c-2.md) is issued or when the send type is set to CM_SEND_AND_DEALLOCATE and [Send_Data](../HIS2010/send-data-cpi-c-1.md) is issued.  
