---
title: "SLI_RECEIVE_EX1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 76009b4e-7788-4f89-aa8a-9a03a17af638
 ...
 **lua_flag2**  
 Returned parameter. Contains flags for messages returned by LUA. Returned by [RUI_BID](../HIS2010/rui-bid2.md), [RUI_READ](../HIS2010/rui-read1.md), **RUI_WRITE**, **SLI_BID**, **SLI_RECEIVE**, and [SLI_SEND_EX](../HIS2010/sli-send-ex1.md). Its subparameters are as follows:  
...
## Return Codes  
 ...
 Secondary return code; the buffer with the [SLI_BID](../HIS2010/sli-bid1.md) VCB was released before the **SLI_RECEIVE_EX** with **lua_flag1.bid_enable** set to 1 was issued.  
 ...
 The supplied data segment for **SLI_RECEIVE_EX** or [SLI_SEND_EX](../HIS2010/sli-send-ex1.md) is not a read/write data segment as required.  
 ...
 **SLI_RECEIVE_EX** receives responses, SNA commands, and request unit data from the host. **SLI_RECEIVE_EX** also provides the status of the session to the Windows LUA application.  
 ...
 An [SLI_OPEN](../HIS2010/sli-open1.md) request must complete before SLI_RECEIVE_EX can be issued. However, if SLI_OPEN is issued with lua_init_type set to LUA_INIT_TYPE_PRIM_SSCP, an SLI_RECEIVE_EX over the SSCP normal flow can be issued as soon as SLI_OPEN returns an IN_PROGRESS.  
...
-   LU normal  
 ...
 If [SLI_BID](../HIS2010/sli-bid1.md) successfully completes before SLI_RECEIVE is issued, the Windows LUA interface can be instructed to reuse the last SLI_BID verbs VCB. To do this, issue SLI_RECEIVE_EX with lua_flag1.bid_enable set to 1.  
