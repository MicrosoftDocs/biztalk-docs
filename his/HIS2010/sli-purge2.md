---
title: "SLI_PURGE2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 6f4be507-8715-41d1-b15b-fca724ddb683
caps.latest.revision: 4
---
# SLI_PURGE
The **SLI_PURGE** verb cancels [SLI_RECEIVE](../HIS2010/sli-receive1.md) verbs issued with a wait condition.  
 ...
 **lua_data_ptr**  
 When **SLI_PURGE** is issued, this parameter points to the location of the [SLI_RECEIVE](../HIS2010/sli-receive1.md) verbs VCB that is to be canceled.  
...
## Return Codes  
 ...
 Secondary return code; no [SLI_RECEIVE](../HIS2010/sli-receive1.md) was outstanding when you issued **SLI_PURGE**. One of two situations caused the problem:  
...
## Remarks  
 **SLI_PURGE** cancels [SLI_RECEIVE](../HIS2010/sli-receive1.md) commands with a wait condition.  
