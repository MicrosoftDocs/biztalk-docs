...
Common service verbs (CSVs) are a set of programming functions provided by [!INCLUDE[hishostintegrationserver2009](../includes/hishostintegrationserver2009-md.md)]. The CSVs provide convert, log, trace, and transfer services to applications.  
 ...
 The CSVs and information presented in this section represent an evolving CSV API that is composed of IBM Extended Services for OS/2 and a set of Microsoft Windows extensions that allow for registering and deregistering the application, and that provide an asynchronous entry point for [TRANSFER_MS_DATA](../HIS2010/transfer-ms-data1.md).  
...
-   [Host Integration Server Asynchronous Support](../HIS2010/host-integration-server-asynchronous-support]1.md)  
  
-   [Before Using Windows CSV](../HIS2010/windows-csv-considerations]1.md)  
  
-   [Using CSVs in C Programs](../HIS2010/csvs-in-c-programs]2.md)  
  
-   [Sample Programs](../HIS2010/sample-programs2.md)  
  
-   [CSV Verb Control Block](../HIS2010/csv-verb-control-block1.md)  
  
-   [Bit Ordering](../HIS2010/bit-ordering1.md)  
  
-   [WINCSV Definition](../HIS2010/wincsv-definition2.md)  
  
-   [WINCSV.H File](../HIS2010/wincsv-h-file1.md)  
  
-   [Issuing a CSV](../HIS2010/issuing-a-csv2.md)