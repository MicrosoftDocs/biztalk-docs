...
The **Set_Partner_LU_Name** call (function name **cmspln**) is issued by the invoking program to specify the partner logical unit (LU) name. This call overrides the partner LU name derived from the side information when the [Initialize_Conversation](../HIS2010/initialize-conversation-cpi-c-2.md) call was issued. This call cannot be issued after [Allocate](../HIS2010/allocate-cpi-c-1.md) has been issued. Issuing this call has no effect on the side information itself.  
...
## Remarks  
 Specifying an invalid value for *partner_LU_name* is not detected until [Allocate](../HIS2010/allocate-cpi-c-1.md) is issued.