---
title: "Link Alerts for SDLC and Token Ring1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 78d980f8-1650-481c-ab2c-4ea496c0f115
...
## In This Section  
 [Link Alert Format and Common Subvectors](../HIS2010/link-alert-format-and-common-subvectors1.md)  
  
 [SDLC Failure Alerts](../HIS2010/sdlc-failure-alerts1.md)  
  
 [SDLC Alert Local Logging](../HIS2010/sdlc-alert-local-logging2.md)  
  
 [Token Ring Failure Alerts](../HIS2010/token-ring-failure-alerts2.md)  
  
 For information about the NetView vectors supported by the NVAlert service, see [Alerts Used by Applications and NVAlert](../HIS2010/alerts-used-by-applications-and-nvalert1.md).  
