...
## Operation  
 Note that with APINGD, [Specify_Local_TP_Name](../HIS2010/specify-local-tp-name-cpi-c-1.md) is used to set the local TP name, so [Wait_For_Conversation](../HIS2010/wait-for-conversation-cpi-c-2.md) must be used to wait for the [Accept_Conversation](../HIS2010/accept-conversation-cpi-c-1.md) call to complete, because it will return asynchronously.  
