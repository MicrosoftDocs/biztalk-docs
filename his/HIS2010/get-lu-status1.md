---
title: "GET_LU_STATUS1 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: e26c66ae-d3a1-40d9-a1e2-fbb80f30f40c
...
## Members  
 ...
 tp_id  
 Supplied parameter. Identifies the local transaction program (TP). The value of this parameter was returned by [TP_STARTED](../HIS2010/tp-started1.md) in the invoking TP, or by [RECEIVE_ALLOCATE](../HIS2010/receive-allocate2.md) or RECEIVE_ALLOCATE_EX in the invoked TP.  
  
 plu_alias  
 Supplied parameter. Provides the identifier for the LU about which this TP is inquiring. The value of this parameter was returned by [MC_ALLOCATE](../HIS2010/mc-allocate1.md) or [ALLOCATE](../HIS2010/allocate1.md) in the invoking TP or by **RECEIVE_ALLOCATE** in the invoked TP.  
