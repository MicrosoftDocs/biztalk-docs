...
## Remarks  
 Data processed by [Send_Data](../HIS2010/send-data-cpi-c-1.md) accumulates in the local LUs send buffer until one of the following happens:  
  
-   The local program issues the Flush call or other call that flushes the LUs send buffer. (Some send types, set by [Set_Send_Type](../HIS2010/set-send-type-cpi-c-1.md), include flush functionality.)  
  
-   The buffer is full.  
  
 The allocation request generated by [Allocate](../HIS2010/allocate-cpi-c-1.md) and error information generated by [Send_Error](../HIS2010/send-error-cpi-c-1.md) are also buffered.