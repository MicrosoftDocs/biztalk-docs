...
-   When any of the RTM parameters are changed by the host.  
 ...
 For more information about the use of the **Status-RTM** message, see [RTM Parameters](../HIS2010/rtm-parameters]1.md). For more information about how the application supplies RTM data to the local node, see [Response Time Monitor Data](../HIS2010/response-time-monitor-data2.md).  
