---
title: "TEST_RTS_AND_POST2 | Microsoft Docs"
ms.custom: ""
ms.date: "11/30/2017"
...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 050a713e-8713-42e3-b438-1ab3d9e93ef8
...
The **TEST_RTS_AND_POST** verb allows an application, typically a 5250 emulator, to request asynchronous notification when a partner transaction program (TP) requests send direction.  
 ...
 The following structure describes the verb control block (VCB) used by the **TEST_RTS_AND_POST** verb.  
 ...
 *conv_id*  
 Supplied parameter. Provides the conversation identifier. The value of this parameter was returned by [ALLOCATE](../HIS2010/allocate1.md) in the invoking TP or by **RECEIVE_ALLOCATE** in the invoked TP.  
...
-   These approaches are processor-intensive.  
 ...
 The **TEST_RTS_AND_POST** verb allows an application running on Windows, typically a 5250 emulator, to request asynchronous notification when the partner TP requests send direction.  
