...
## In This Section  
 [Working with the Managed Provider for DB2 GetSchema Methods](../HIS2010/working-with-the-managed-provider-for-db2-getschema-methods2.md)  
  
 [Understanding the Schema Collections for the Managed Provider for DB2](../HIS2010/understanding-the-schema-collections-for-the-managed-provider-for-db22.md)