...
## In This Section  
 [MQSC Adapter Features](../HIS2010/mqsc-adapter-features1.md)  
  
 [How to Add the MQSC Adapter to a BizTalk Server Installation](../HIS2010/how-to-add-the-mqsc-adapter-to-a-biztalk-server-installation2.md)  
 ...
 [How to Configure a Client Channel Definition File](../HIS2010/how-to-configure-a-client-channel-definition-file1.md)  
  
 [How to Configure the MQSC Adapter for Transactional Messaging](../HIS2010/how-to-configure-the-mqsc-adapter-for-transactional-messaging1.md)  
  
 [How to Configure SSL for the MQSC Adapter: Transactional](../HIS2010/how-to-configure-ssl-for-the-mqsc-adapter-transactional1.md)  
  
 [MQSC Adapter Schema](../HIS2010/mqsc-adapter-schema1.md)