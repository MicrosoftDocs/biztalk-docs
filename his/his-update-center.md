...
> [!NOTE]
> Updates to the Microsoft OLE DB Provider for DB2 v4.0 and later versions are released as new MSI installation packages. This requires that you remove the previous version of the Microsoft OLE DB Provider for DB2 provider before you install the updated version.
