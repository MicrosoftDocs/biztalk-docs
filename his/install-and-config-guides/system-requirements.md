...
|  .NET Framework  | Microsoft .NET Framework 4.6 using the [Web installer](https://go.microsoft.com/fwlink/p/?LinkId=528259) (<https://go.microsoft.com/fwlink/p/?LinkId=528259>) **OR** the [off-line installer](https://dotnet.microsoft.com/download/dotnet-framework/net46).  |
