 ...
 **Planning**  
 ...
 We recommend that you read the Host Integration Server [Installation Guide](../install-and-config-guides/installation-guide.md), which covers the following topics:  
