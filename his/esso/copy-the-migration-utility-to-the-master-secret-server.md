...
The Migration Utility is not installed with the rest of [!INCLUDE[hisHostIntServNoVersion](../esso/includes/hishostintservnoversion-md.md)]. You must manually copy it to the master secret server.  
