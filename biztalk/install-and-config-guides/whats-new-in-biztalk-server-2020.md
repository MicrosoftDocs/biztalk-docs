...
| Management APIs | Manage your environment remotely using the new REST APIs with full Swagger support. <br/><br/>[REST API reference](https://docs.microsoft.com/rest/api/overview/biztalk/?view=rest-biztalk-2020)|
