...
5. In the left pane, select **Filters**, and then do the following actions. Click **OK** to continue.  
   ...
   > [!NOTE]
   >  BTAHL7 drops the message at the file drop location \<*drive*\>:\\Program Files\\Microsoft BizTalk \<version\> Accelerator for HL7\\SDK\\End-to-End Tutorial\\Tutorial_sendMsg_RX.  
