...
|||  
|-|-|  
|TID|See transaction ID.|  
|transaction ID (TID)|A globally-unique identifier that SAP associates with each logical unit of work (LUW).|  
  
####  <a name="U"></a> U  
  
|||  
|-|-|  
|Uniform Resource Identifier|See connection URI.|  
  
####  <a name="W"></a> W  
  
|||  
|-|-|  
|WCF|See Windows Communication Framework.|  
...
|Windows Communication Framework (WCF)|A Microsoft service-oriented communication infrastructure. The framework inherently provides clients with a service programming model and a channel programming model for finer control of message exchanges.|  
