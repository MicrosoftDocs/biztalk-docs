---
description: "Learn more about: Step 4: Test the InterAct Store and Forward (Pull) End-to-End Scenario"
title: "Step 4: Test the InterAct Store and Forward (Pull) End-to-End Scenario | Microsoft Docs"
ms.custom: ""
ms.date: "06/08/2017"
...
manager: "anneta"
---
# Step 4: Test the InterAct Store and Forward (Pull) End-to-End Scenario
Before you begin the steps in this section, you must complete [Step 3B: Bind the orchestration with dynamic send port for InterAct Store and Forward (Pull) Scenario](../../adapters-and-accelerators/fileact-interact/step-3b-bind-orchestration-with-dynamic-send-port-for-interact-scenario.md).  
