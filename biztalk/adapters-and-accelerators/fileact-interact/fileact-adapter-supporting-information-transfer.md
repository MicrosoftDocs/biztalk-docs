...
-   File description and file information  
  
-   Transfer description and transfer information  
  
-   Acknowledgement description and acknowledgement information  
  
-   Rejection description and reject information  
  
> [!NOTE]
>  One of the components of file information defines compression and decompression. Compression and decompression are the responsibility of the application, not the adapter.  
