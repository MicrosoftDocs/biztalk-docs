...
# [Step 3C: Add FILE send port to get Sw:HandleRequest-InterAct Store and Forward](step-3c-add-file-send-port-to-get-sw-handlerequest-interact-store-and-forward.md)
