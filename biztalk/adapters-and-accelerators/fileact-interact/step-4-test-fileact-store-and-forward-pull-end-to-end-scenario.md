---
description: "Learn more about: Step 4: Test FileAct Store and Forward (Pull) End-to-End Scenario"
title: "Step 4: Test FileAct Store and Forward (Pull) End-to-End Scenario"
ms.custom: ""
ms.date: "06/08/2017"
...
ms.topic: "article"
---
# Step 4: Test FileAct Store and Forward (Pull) End-to-End Scenario
Complete the steps in the [Step 3B: Bind the orchestration with dynamic send port for FileAct Store and Forward (Pull) Scenario](../../adapters-and-accelerators/fileact-interact/step-3b-bind-orchestration-with-dynamic-send-for-fileact-store-and-forward.md) before you begin the steps in this section.
