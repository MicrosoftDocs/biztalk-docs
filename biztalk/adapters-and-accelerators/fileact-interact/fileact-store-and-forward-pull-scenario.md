---
description: "Learn more about: FileAct Store and Forward (Pull) Scenario"
title: "FileAct Store and Forward (Pull) Scenario | Microsoft Docs"
ms.custom: ""
ms.date: "06/08/2017"
...
manager: "anneta"
---
# FileAct Store and Forward (Pull) Scenario
Complete [Preparing to Use the Tutorial](../../adapters-and-accelerators/fileact-interact/preparing-to-use-the-tutorial1.md) before you begin the steps in this scenario.
  
## Steps in this section  
  
-   [Step 1: Configure the SWIFT Adapter for the FileAct Store and Forward (Pull) Scenario](../../adapters-and-accelerators/fileact-interact/step-1-configure-the-swift-adapter-for-fileact-store-and-forward-pull-scenario.md)
