...
- Make sure that you install all the applicable hotfixes for all the products that you install as part of your deployment. For more information, see the following sources:
  ...
  - BizTalk Server Installation Instructions at [http://go.microsoft.com/fwlink/?LinkId=81041](https://go.microsoft.com/fwlink/?LinkId=81041).

  - Microsoft [!INCLUDE[btsWinNoVersion](../../includes/btswinnoversion-md.md)] Web site at [http://go.microsoft.com/fwlink/?linkid=48685](https://go.microsoft.com/fwlink/?linkid=48685).

  - Microsoft Download Center Web site at [http://go.microsoft.com/fwlink/?linkid=48686](https://go.microsoft.com/fwlink/?linkid=48686).

  - [!INCLUDE[btsWinUpdate](../../includes/btswinupdate-md.md)] Web site at [http://go.microsoft.com/fwlink/?linkid=48687](https://go.microsoft.com/fwlink/?linkid=48687).
