...
|SQL Server Integration Services (SSIS)|A component that is used to import, export, and transform data from different data sources. Previously called data transformation service (DTS).|  
...
|synonym|An alternative name for a schema-scoped object; introduced in SQL Server 2005.|  
