...
>
>  You can always use the schemas generated using the ‘native’ SQL adapter provided with earlier versions of [!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)]. For more information, see [Using FOR XML queries with the WCF-SQL Adapter](/archive/technet-wiki/3480.using-for-xml-queries-with-the-wcf-sql-adapter).
