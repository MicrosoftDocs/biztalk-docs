...
- **Running setup on a 64-bit computer might throw an error while accessing schema file**  
   ...
   The [!INCLUDE[adapterpacknoversion](../includes/adapterpacknoversion-md.md)] setup throws an error while accessing the **Microsoft.Adapters._\<AdapterName\>_\_schema.xml** file, but proceeds with the adapter installation.  
   ...
   **Resolution**  
   ...
   Manually copy the **Microsoft.Adapters._\<AdapterName\>_\_schema.xml** file from `C:\Program Files\Microsoft BizTalk Adapter Pack(x64)\IIS Schemas`" to `C:\Windows\System32\inetsrv\config\schema`.  
