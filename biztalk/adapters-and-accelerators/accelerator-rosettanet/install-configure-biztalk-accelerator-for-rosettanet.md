---
title: "Install BizTalk Server Accelerator for RosettaNet (BTARN) | Microsoft Docs"
ms.date: "06/08/2017"
...
> [!NOTE]
>  On the Enterprise Edition of BizTalk Server, you can install only the Enterprise Edition of [!INCLUDE[BTARN_CurrentVersion_FirstRef](../Token/BTARN_CurrentVersion_FirstRef_md.md)]. On the Standard Edition of BizTalk Server, you can install only the Standard Edition of [!INCLUDE[BTARN_CurrentVersion_FirstRef](../Token/BTARN_CurrentVersion_FirstRef_md.md)].  
  
 The BTARN installation includes the following:  
  
-   [!INCLUDE[btaBTARN3.3abbrevnonumber](../Token/btaBTARN3.3abbrevnonumber_md.md)] Administration  
  
-   BizTalk Orchestration Designer XLANG schedules (Partner Interface Process patterns)  
  
-   RosettaNet Implementation Framework (RNIF)  
  
-   [!INCLUDE[btaBTARN3.3abbrevnonumber](../Token/btaBTARN3.3abbrevnonumber_md.md)] database  
...
* BTARN allows you to add only individual service accounts, and not groups, to the [!INCLUDE[btsBizTalkServerNoVersion](../Token/btsBizTalkServerNoVersion_md.md)] Administrators group or the BizTalk Application Users group.  
* You need to create a WebService extension for BTSHTTPReceive.dll, configuring the IIS isolation mode. For more information, see the "404 Not found error when sending a HTTP request" entry in the "Troubleshooting: Issues and Resolutions" topic at [http://go.microsoft.com/fwlink/?LinkId=188560](http://go.microsoft.com/fwlink/?LinkId=188560). Also, see the "How to Configure IIS for an HTTP Receive Location" topic in [!INCLUDE[btsBizTalkServerNoVersion](../Token/btsBizTalkServerNoVersion_md.md)] Help.  
...
*  A separate group must be used for role - BizTalk Administrator, BizTalk Host Users, and BizTalk Isolated Host Users during the configuration of [!INCLUDE[btsBizTalkServerNoVersion](../Token/btsBizTalkServerNoVersion_md.md)].  
...
7.  To configure the WebApps feature, in the **Microsoft BTRAN Configuration** dialog box, click **WebApps** in the left pane, and then click **Enable the Runtime feature on this computer**. Enter the appropriate [!INCLUDE[btsBizTalkServerNoVersion](../Token/btsBizTalkServerNoVersion_md.md)] name and port number, or select the defaults. Select the appropriate Web application virtual folder.  
...
10. On the **Configuration Completed** page, click **Finish**.  
    ...
    > [!NOTE]
    >  After you install BTARN, your system administrator must add users to the BAS Business User, Business Manager, and Business Administrator groups. If you are a system administrator, you will have to populate these groups and log off, and then log in adding yourself to the groups. For more information about adding users to these groups, see [Additional Configuration](../Topic/Additional%20Configuration.md).  
  
    > [!WARNING]
    >  Three different groups must be used while configuring [!INCLUDE[btsBizTalkServerNoVersion](../Token/btsBizTalkServerNoVersion_md.md)] for BizTalk Administrator, BizTalk Host Users, and BizTalk Isolated Host Users.  
...
-   On computers where you have configured an Internet Information Services (IIS) virtual server with Secure Sockets Layer (SSL), you must configure the virtual server to accept the client certificate. See the "Step 4: Enabling Secure Sockets Layer in IIS" topic in the **Double Action Tutorial** (in the Introduction node of [!INCLUDE[btaBTARN3.3abbrevnonumber](../Token/btaBTARN3.3abbrevnonumber_md.md)] Help).  
...
Restart your computer to apply any modifications made in configuration and permissions.  
 ...
 For more information about installing [!INCLUDE[btaBTARN3.3abbrevnonumber](../Token/btaBTARN3.3abbrevnonumber_md.md)] on a single server, see the **Loopback Tutorial** (in the Introduction node of [!INCLUDE[btaBTARN3.3abbrevnonumber](../Token/btaBTARN3.3abbrevnonumber_md.md)] Help).  
  
## In This Section  
 
  
 
-   [Upgrading the RosettaNet Accelerator](../Topic/Upgrading%20to%20BizTalk%202013%20R2%20RosettaNet%20Accelerator.md)  
  
-   [Uninstalling the RosettaNet Accelerator](../Topic/Uninstalling%20the%20RosettaNet%20Accelerator.md)  
  
-   [Troubleshooting Your Installation](../Topic/Troubleshooting%20Your%20Installation4.md)  
  
-   [Installation Known Issues](../Topic/Installation%20Known%20Issues2.md)