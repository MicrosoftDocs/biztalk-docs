...
* You need to create a WebService extension for BTSHTTPReceive.dll, configuring the IIS isolation mode. For more information, see [404 Not found error when sending a HTTP request](/biztalk/adapters-and-accelerators/accelerator-rosettanet/troubleshooting-issues-and-resolutions3#404-not-found-error-when-sending-a-http-request). Also, see [How to Configure IIS for an HTTP Receive Location](../../core/how-to-configure-iis-for-an-http-receive-location.md).
