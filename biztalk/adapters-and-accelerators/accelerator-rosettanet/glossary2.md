...
---
# Glossary
Microsoft® [!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)]uses the following glossary terms.  
...
## B  
 ...
 An add-on product to Microsoft® [!INCLUDE[btsBizTalkServer2006r3](../../includes/btsbiztalkserver2006r3-md.md)] that helps organizations to build RosettaNet Implementation Framework (RNIF)-compliant solutions.  
  
 See also: [!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)] Administration  
 ...
 A Microsoft product for business-process automation and application integration both in and between businesses. [!INCLUDE[btsBizTalkServer2006r3](../../includes/btsbiztalkserver2006r3-md.md)] provides a powerful Web-based development and execution environment that integrates loosely coupled, long-running business processes, both in and between businesses.  
  
 [!INCLUDE[btsBizTalkServer2006r3](../../includes/btsbiztalkserver2006r3-md.md)] features include the composition of new and existing XLANG schedules; integration among existing applications; the definition of document specifications and specification transformations; and the monitoring and logging of run-time activity.  
...
## O  
 ...
 See also: trading partner, my organization  
