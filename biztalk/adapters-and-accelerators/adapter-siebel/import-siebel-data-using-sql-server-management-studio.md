...
4. In the **Execute Package Utility** dialog box, click **Close**.
   ...
   For more information about running packages, see "Running Packages" at [https://go.microsoft.com/fwlink/?LinkId=94972](/sql/integration-services/packages/run-integration-services-ssis-packages). For any other information related to SSIS packages, see "Package How-to Topics (SSIS)" at [https://go.microsoft.com/fwlink/?LinkId=94973](/previous-versions/sql/sql-server-2008-r2/ms137712(v=sql.105)).
