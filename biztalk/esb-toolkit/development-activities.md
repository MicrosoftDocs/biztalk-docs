...
-   [How to: Convert a Text Document to XML and Route to a File Location Using an Itinerary Routing Slip](../esb-toolkit/convert-text-document-to-xml-and-route-to-location-using-itinerary-routing-slip.md)  
  
-   [How to: Create an Itinerary to Dynamically Route a Message to an Email Address Using an LDAP Query](../esb-toolkit/create-itinerary-to-dynamically-route-message-to-an-email-address-using-ldap.md)  
...
-   [How to: Validate a Message Using an ESB On-Ramp](../esb-toolkit/how-to-validate-a-message-using-an-esb-on-ramp.md)  
  
-   [How to: Publish a Service to the UDDI 3.0 Registry](../esb-toolkit/how-to-publish-a-service-to-the-uddi-3-0-registry.md)  
...
-   [How to: Enable BAM Tracking in an ESB Itinerary Service](../esb-toolkit/how-to-enable-bam-tracking-in-an-esb-itinerary-service.md)  
  
-   [How to: Implement Content-Based Routing Using Message Context Properties](../esb-toolkit/how-to-implement-content-based-routing-using-message-context-properties.md)