...
```
 ...
 For detailed information about the configuration that is necessary in the **esb.resolvers** node, see [Source Schema for the Unity Application Block](/previous-versions/msp-n-p/ff648865(v=pandp.10)) ([https://go.microsoft.com/fwlink/?LinkId=188288](/previous-versions/msp-n-p/ff648865(v=pandp.10))) on MSDN.
