...
## BAM Alerting
 ...
 BAM alerting is built on the [!INCLUDE[btsSQLServerNoVersion](../includes/btssqlservernoversion-md.md)] Notification Services infrastructure. To enable tracing on BAM alerting, see the Notification Services troubleshooting topics at [http://go.microsoft.com/fwlink/?LinkId=79416](https://go.microsoft.com/fwlink/?LinkId=79416).
...
### Viewing the WCF Trace File
 To analyze the WCF trace you use the WCF Service Trace Viewer Tool. For more information about the Service Trace Viewer Tool, see [http://go.microsoft.com/fwlink/?LinkId=75218](https://go.microsoft.com/fwlink/?LinkId=75218).
