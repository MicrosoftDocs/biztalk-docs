...
-   [How to List Affiliate Applications](../core/how-to-list-affiliate-applications.md)  
  
-   [How to List the Properties of an Affiliate Application](../core/how-to-list-the-properties-of-an-affiliate-application.md)  
  
-   [How to Clear the Application Cache](../core/how-to-clear-the-application-cache.md)  
  
-   [How to Set the SSO Server Using the Client Utility](../core/how-to-set-the-sso-server-using-the-client-utility.md)  
  
-   [How to Display the SSO Server Using the Client Utility](../core/how-to-display-the-sso-server-using-the-client-utility.md)  
  
-   [How to Set Credentials for the Affiliate Application Using the Client Utility](../core/how-to-set-credentials-for-the-affiliate-application-using-the-client-utility.md)