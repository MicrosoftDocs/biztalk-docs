...
- The interceptor stops the IC polling thread when last BamTrackingService in application domain is stopped
  ...
  For more information on WorkflowRuntime and loading configuration information, see [https://go.microsoft.com/fwlink/?LinkId=83314](/dotnet/api/system.workflow.runtime.workflowruntime).
