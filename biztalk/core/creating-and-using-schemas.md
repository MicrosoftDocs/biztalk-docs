---
title: "Creating and Using Schemas | Microsoft Docs"
ms.custom: ""
ms.date: "06/08/2017"
...
## Generating a Schema  
 The following procedures show how to generate a schema and how to set the target namespace.  
  
#### To generate a schema using BizTalk Editor  
...
5.  Click **Browse** to locate the input file for which you want to generate a schema, and then click **OK**.  
     ...
     Next, you must set the target namespace.  
  
#### To set the target namespace  
