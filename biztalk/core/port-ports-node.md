...
|Modifier|Attribute|xs:int|Specifies the type modifier for the port.|Required|Default value: none<br /><br /> Possible values include those available in the [Microsoft.BizTalk.ExplorerOM.PortModifier](/previous-versions/) enumeration.|  
|BindingOption|Attribute|xs:int|Defines the type of binding for the port.|Required|Default value: none<br /><br /> Possible values include those available in the [Microsoft.BizTalk.ExplorerOM.BindingType](/previous-versions/) enumeration.|  
