...
|If necessary, remove the assemblies that were included in the application from the global assembly cache (GAC).|[How to Uninstall an Assembly from the GAC](../Topic/How%20to%20Uninstall%20an%20Assembly%20from%20the%20GAC.md)|  
