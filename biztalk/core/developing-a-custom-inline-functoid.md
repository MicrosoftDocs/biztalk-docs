...
1. Call **AddScriptTypeSupport** with [Microsoft.BizTalk.BaseFunctoids.ScriptType](/previous-versions/) to enable inline code and set the supported script type.  
...
2. In the constructor, call **AddScriptTypeSupport** with [Microsoft.BizTalk.BaseFunctoids.ScriptType](/previous-versions/) to enable inline code and set the supported script type.  
