...
## Remarks  
 ...
 If **ReceiveNotification** is waiting when you call [ShutdownAdapter](../core/issonotification-shutdownadapter-method.md), then **ReceiveNotification** returns a SHUTDOWN notification as the last notification. The SHUTDOWN notification preempts any other pending notifications.  
