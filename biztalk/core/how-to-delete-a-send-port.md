...
-   The send port is not referenced by a party. For instructions on removing a reference to a send port from a party, see [How to View or Edit a Party](../Topic/How%20to%20View%20or%20Edit%20a%20Party.md).  
