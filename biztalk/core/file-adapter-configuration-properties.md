...
|FileName|VT_BSTR|Specify the name of the file where the file send handler writes the message.|For information about restrictions on this property, see [Restrictions on the File Mask and File Name Properties](/previous-versions/).|The default value is %MessageID%.xml.|  
