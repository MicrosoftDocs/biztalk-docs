...
- If SSO Administration is installed on a remote computer, you can run a remote [IssueTicket](../../technical-reference/issoticket-issueticket-method.md) operation. All traffic between the SSO Administration module and the Runtime module (ENTSSO service) is encrypted.  
