 ...
 **SQL Server roles**. To grant a user access to a database, you must be a member of the securityadmin or sysadmin group.
 ...
 For more information about roles in SQL Server, see "Roles in the SQL Server Architecture" at [https://go.microsoft.com/fwlink/?LinkId=56205](https://go.microsoft.com/fwlink/?LinkId=56205).
