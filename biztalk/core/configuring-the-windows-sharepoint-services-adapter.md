...
-   [How to Configure Send Ports Using Windows Sharepoint Services Context Properties](../core/configure-send-ports-using-sharepoint-context-properties-in-biztalk-server.md)  
