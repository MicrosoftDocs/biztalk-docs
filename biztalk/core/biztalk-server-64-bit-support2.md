...
>
> [!NOTE]
>  If your [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] applications connect to a Windows Server 2003 computer (like SSO, SQL adapter, MQSeries, MQSAgent, Oracle, and so on), then install [934016](https://support.microsoft.com/kb/934016) and [934849](https://support.microsoft.com/kb/934849) on these Windows Server 2003 servers.
>
> [!NOTE]
