...
-   Regardless of whether an envelope schema has a single root or multiple roots, setting the [Root Reference](../core/root-reference-node-property-of-all-schemas.md) property is not required.  
