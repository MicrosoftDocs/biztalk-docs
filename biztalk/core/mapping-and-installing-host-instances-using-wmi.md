---
title: "Mapping and Installing Host Instances Using WMI | Microsoft Docs"
ms.custom: ""
ms.date: "06/08/2017"
...
Use the following code to map and install host instances using the [MSBTS_ServerHost](../core/msbts-serverhost-wmi.md) and [MSBTS_HostInstance](../core/msbts-hostinstance-wmi.md) classes.  
