...
- Contractual. The interface to the service implements the contract between users and the service.
  ...
  For more information about service oriented architectures, see "Service Interface" at [https://go.microsoft.com/fwlink/?LinkId=46185](/documentation/) and "Service-Oriented Integration" at [https://go.microsoft.com/fwlink/?LinkId=46186](/documentation/).
