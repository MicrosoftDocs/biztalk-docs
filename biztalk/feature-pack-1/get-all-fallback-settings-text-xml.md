---
title: "Get all fallback settings text xml | Microsoft Docs"
ms.custom: ""
ms.date: "06/08/2017"
...
ms.assetid: c21a91b7-fba1-45ca-8ec9-ce1b12cf69f7
caps.latest.revision: 2
author: "tordgladnordahl"
ms.author: "tonordah"
manager: "anneta"
---
# Get all fallback settings: text/xml
## FallbackSettings
...
| Response | Content          |
| ------------- | ----------- |
| Curl | curl -X GET --header 'Accept: text/xml' 'http://biztalkfp1.westus.cloudapp.azure.com/BizTalkManagementService/FallbackSettings'|
| Response Body | |
| Response Code | 200|
