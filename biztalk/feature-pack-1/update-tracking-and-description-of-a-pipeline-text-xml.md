---
title: "Update Tracking and Description of a Pipeline text xml | Microsoft Docs"
ms.custom: ""
ms.date: "06/08/2017"
...
ms.assetid: a0c229a4-2ccc-4de9-99f8-0e5a87b1879e
caps.latest.revision: 2
author: "tordgladnordahl"
ms.author: "tonordah"
manager: "anneta"
---
# Update Tracking and Description of a Pipeline: text/xml
...
| Response | Content          |
| ------------- | ----------- |
| Curl | curl -X PUT --header 'Content-Type: text/xml' --header 'Accept: application/json' -d '{pipelineName}' 'http://biztalkfp1.westus.cloudapp.azure.com/BizTalkManagementService/Pipelines/%7BpipelineName%7D'|
...
{
  "pragma": "no-cache",
  "date": "Mon, 24 Apr 2017 09:17:45 GMT",
