---
title: "Create an agreement text json | Microsoft Docs"
ms.custom: ""
ms.date: "06/08/2017"
...
ms.assetid: 4efcad1c-b091-4110-bd7f-110cad070928
caps.latest.revision: 4
author: "tordgladnordahl"
ms.author: "tonordah"
manager: "anneta"
---
# Create an agreement: text/json
##  Create an agreement
...
| Response | Content          |
| ------------- | ----------- |
| Curl | curl -X POST --header 'Content-Type: text/json' --header 'Accept: text/plain' -d 'http://biztalkfp1.westus.cloudapp.azure.com/BizTalkManagementService/Agreements'|
...
{
  "pragma": "no-cache",
  "date": "Fri, 21 Apr 2017 04:53:20 GMT",
