---
title: "Update fallback settings application x www form urlencoded | Microsoft Docs"
ms.custom: ""
ms.date: "06/08/2017"
...
ms.assetid: 798c7984-57a6-44b6-a6f2-f50a8b50439b
caps.latest.revision: 2
author: "tordgladnordahl"
ms.author: "tonordah"
manager: "anneta"
---
# Update fallback settings: application/x-www-form-urlencoded
...
| Response | Content          |
| ------------- | ----------- |
| Curl | curl -X PUT --header 'Content-Type: application/x-www-form-urlencoded' --header 'Accept: text/plain' -d 'http://biztalkfp1.westus.cloudapp.azure.com/BizTalkManagementService/FallbackSettings'|
| Response Body |Invalid protocol: .|
| Response Code |404|
...
{
  "pragma": "no-cache",
  "date": "Mon, 24 Apr 2017 08:29:25 GMT",
