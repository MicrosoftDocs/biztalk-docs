---
title: "Update Party application xml | Microsoft Docs"
ms.custom: ""
ms.date: "06/08/2017"
...
ms.assetid: e6021f3b-3873-4555-8394-76f6d4ab3948
caps.latest.revision: 2
author: "tordgladnordahl"
ms.author: "tonordah"
manager: "anneta"
---
# Update Party: application/xml
## Update Party
...
| Response | Content          |
| ------------- | ----------- |
| Curl | curl -X PUT --header 'Content-Type: application/xml' --header 'Accept: application/json' -d '{partyName}' 'http://biztalkfp1.westus.cloudapp.azure.com/BizTalkManagementService/Parties/%7BpartyName%7D'|
| Response Code | 404|
...
{
  "pragma": "no-cache",
  "date": "Tue, 25 Apr 2017 01:36:35 GMT",
