---
title: "Update fallback settings application json | Microsoft Docs"
ms.custom: ""
ms.date: "06/08/2017"
...
ms.assetid: c7067438-bc43-461c-b216-6ae40c3aeb13
caps.latest.revision: 2
author: "tordgladnordahl"
ms.author: "tonordah"
manager: "anneta"
---
# Update fallback settings: application/json
...
| Response | Content          |
| ------------- | ----------- |
| Curl | curl -X PUT --header 'Content-Type: application/json' --header 'Accept: text/plain' -d 'http://biztalkfp1.westus.cloudapp.azure.com/BizTalkManagementService/FallbackSettings'|
