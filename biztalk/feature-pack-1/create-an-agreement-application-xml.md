---
title: "Create an agreement application xml | Microsoft Docs"
ms.custom: ""
ms.date: "06/08/2017"
...
ms.assetid: b598be68-da25-417a-aeeb-f8ccc80a4ff7
caps.latest.revision: 4
author: "tordgladnordahl"
ms.author: "tonordah"
manager: "anneta"
---
# Create an agreement: application/xml
## Create an agreement
...
| Response | Content          |
| ------------- | ----------- |
| Curl | curl -X POST --header 'Content-Type: application/xml' --header 'Accept: text/plain' -d 'http://biztalkfp1.westus.cloudapp.azure.com/BizTalkManagementService/Agreements'|
...
{
  "pragma": "no-cache",
  "date": "Fri, 21 Apr 2017 04:59:07 GMT",
