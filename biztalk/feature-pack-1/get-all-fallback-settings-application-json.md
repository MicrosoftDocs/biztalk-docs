---
title: "Get all fallback settings application json | Microsoft Docs"
ms.custom: ""
ms.date: "06/08/2017"
...
ms.assetid: 07f2cf92-2859-4b4b-8cdc-284f1834884c
caps.latest.revision: 2
author: "tordgladnordahl"
ms.author: "tonordah"
manager: "anneta"
---
# Get all fallback settings: application/json
## FallbackSettings
...
| Response | Content          |
| ------------- | ----------- |
| Curl | curl -X GET --header 'Accept: application/json' 'http://biztalkfp1.westus.cloudapp.azure.com/BizTalkManagementService/FallbackSettings'|
| Response Body | |
| Response Code | 200|
...
{
  "pragma": "no-cache",
  "date": "Mon, 24 Apr 2017 07:11:28 GMT",
