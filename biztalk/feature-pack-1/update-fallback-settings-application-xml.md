---
title: "Update fallback settings application xml | Microsoft Docs"
ms.custom: ""
ms.date: "06/08/2017"
...
ms.assetid: 5fc7f706-a4ef-4b0d-a515-e34c2e6acedf
caps.latest.revision: 6
author: "tordgladnordahl"
ms.author: "tonordah"
manager: "anneta"
---
# Update fallback settings: application/xml
...
| Response | Content          |
| ------------- | ----------- |
| Curl | curl -X PUT --header 'Content-Type: application/xml' --header 'Accept: text/plain' -d 'http://biztalkfp1.westus.cloudapp.azure.com/BizTalkManagementService/FallbackSettings'|
...
{
  "pragma": "no-cache",
  "date": "Mon, 24 Apr 2017 08:36:59 GMT",
