 ...
 **Removing or changing the state of an artifact can cause an application not to work**
 ...
 When you add a reference from one application to another and make any changes to the state of an artifact on which another application depends, or you remove the artifact, the application that has the dependency will not function correctly. For more information about changing the state of an artifact, see the section on the appropriate artifact in [Managing Artifacts](https://go.microsoft.com/fwlink/?LinkID=154725) (https://go.microsoft.com/fwlink/?LinkID=154725).
