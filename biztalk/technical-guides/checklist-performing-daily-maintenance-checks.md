...
|Check the event logs for errors and warnings (administration check).|[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)] errors and warning events are saved in the application log. The event source is "[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]."|  
