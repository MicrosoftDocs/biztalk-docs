...
## How to Export to a Binding File
 ...
 For information about how hosts and trust levels are stored in binding files, how host and trust levels in a binding file are matched to hosts and trust levels in the application, and the order in which bindings are applied, see [Binding Files and Application Deployment](https://go.microsoft.com/fwlink/?LinkID=154726) (https://go.microsoft.com/fwlink/?LinkID=154726). For instructions on how to export bindings for a BizTalk application, see [How to Export Bindings for a BizTalk Application](https://go.microsoft.com/fwlink/?LinkId=155009) (https://go.microsoft.com/fwlink/?LinkId=155009).
