...
#### [Checklist: Optimizing Performance on Hyper-V](TocOutOfQuery)
...
## [Microsoft BizTalk Server 2010 Operations Guide](TocOutOfQuery)
...
##### [Checklist: Configuring SQL Server](TocOutOfQuery)
...
##### [Checklist: Maintaining and Troubleshooting BizTalk Server Databases](TocOutOfQuery)
...
###### [Tools and Utilities for Troubleshooting](TocOutOfQuery)
...
###### [Tools for Testing](TocOutOfQuery)
...
##### [Checklist: Installing and Configuring Certificates](TocOutOfQuery)
...
##### [Checklist: Planning for Operations in a Secure Environment](TocOutOfQuery)
...
##### [Installing and Configuring Digital Certificates](TocOutOfQuery)
###### [How to Install Certificates for BizTalk Server](how-to-install-certificates-for-biztalk-server.md)
###### [Configuring Certificates for MIME/SMIME Messages](TocOutOfQuery)
####### [How to Configure BizTalk Server to Receive Encrypted MIME/SMIME Messages](TocOutOfQuery)
...
####### [How to Configure BizTalk Server to Receive Signed MIME/SMIME Messages](TocOutOfQuery)
####### [How to Configure BizTalk Server to Send Signed MIME/SMIME Messages](TocOutOfQuery)
...
#### [System-Level Bottlenecks](TocOutOfQuery)
...
###### [Step 4: Configure BizTalk Server Environment for Load Testing](TocOutOfQuery)
