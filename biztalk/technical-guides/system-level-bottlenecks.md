...
-   **Defragment your disks -** Use the available at [PageDefrag utility](/sysinternals/downloads/pagedefrag) (https://go.microsoft.com/fwlink/?LinkId=108976) to defragment the Windows paging file and pre-allocate the Master File Tables.
