...
title: "Step 4: Configure BizTalk Server Environment for Load Testing"
ms.custom: ""
ms.date: "06/29/2017"
...
### Create BizTalk Server Send and Receive Hosts
 Follow the steps in the BizTalk Server Documentation topic [How to Create a New Host](../core/how-to-create-a-new-host.md) to create a BizTalk Server “Send” host for Send Ports and Send adapter handlers. Configure the host with the following properties:
...
### Create a BizTalk Server Receive Port
 Follow the steps in the topic [How to Create a Receive Port](../core/how-to-create-a-receive-port.md) in the BizTalk Server documentation to create a One-Way Receive Port. When creating the Receive port, leave all properties at default values except as noted in the table below:
...
### Create a BizTalk Server Send Port
 Follow the steps in the topic [How to Create a Send Port](../core/how-to-create-a-send-port2.md) in the BizTalk Server documentation to create a **Static One-Way** Send Port. When creating the Send port, leave all properties at default values except as noted in the table below:
...
### Configure a Computer to Consume Messages Sent by the BizTalk Server Send Port
 As described earlier, the IndigoService.exe is designed to consume messages sent via WCF. It includes the following 4 files, and they should be on the computer that you would like to run IndigoService.exe:
