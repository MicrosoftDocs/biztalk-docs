...
|Ensure that the MSDTC Security Configuration is enabled (security check).|See **Set the appropriate MSDTC Security Configuration options** [Troubleshooting Problems with MSDTC](../core/troubleshooting-problems-with-msdtc.md).|  
