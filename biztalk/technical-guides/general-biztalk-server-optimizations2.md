...
>  While there are benefits to creating additional host instances, there are also potential drawbacks if too many host instances are created. Each host instance is a Windows service (BTSNTSvc.exe), which generates additional load against the MessageBox database and consumes computer resources (such as CPU, memory, threads).
 ...
 For more information about modifying BizTalk Server Host properties, see "How to Modify Host Properties" in the BizTalk Server help at [https://go.microsoft.com/fwlink/?LinkId=101588](/previous-versions/).
...
- "Managing the BAM Event Bus Service" at [https://go.microsoft.com/fwlink/?LinkId=101590](/previous-versions/).

- "Creating Instances of the BAM Event Bus Service" at [https://go.microsoft.com/fwlink/?LinkId=101591](/previous-versions/).
...
-   “Troubleshooting MessageBox Latency Issues” at [https://go.microsoft.com/fwlink/?LinkId=114747](/previous-versions/)

-   “Identifying Performance Bottlenecks” at [https://go.microsoft.com/fwlink/?LinkID=104418](/previous-versions/)

-   “Avoiding DBNETLIB Exceptions” at [https://go.microsoft.com/fwlink/?LinkID=108787](/previous-versions/)

-   “Avoiding TCP/IP Port Exhaustion” at [https://go.microsoft.com/fwlink/?LinkID=101610](/previous-versions/)

-   “Setting the EPM Threadpool Size” at [https://go.microsoft.com/fwlink/?LinkId=114748](/previous-versions/)
