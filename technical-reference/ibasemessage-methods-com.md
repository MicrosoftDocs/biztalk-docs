...
The methods of the **IBaseMessage** interface are listed here. For a complete list of **IBaseMessage** interface members, see the [IBaseMessage Members](ibasemessage-members-com.md) topic.
