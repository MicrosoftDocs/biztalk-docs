...
Use the following code to create, update, or delete a host instance using the [MSBTS\_HostSetting](msbts-hostsetting-wmi.md) class.
...
[MSBTS\_HostSetting (WMI)](msbts-hostsetting-wmi.md)
