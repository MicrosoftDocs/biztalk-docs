...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Aa578245(v=BTS.80)
ms:contentKeyID: 51530682
ms.date: 08/30/2017
...
The methods of the **IBTBatchTransmitter** interface are listed here. For a complete list of **IBTBatchTransmitter** interface members, see the [IBTBatchTransmitter Members](ibtbatchtransmitter-members-com.md) topic.
