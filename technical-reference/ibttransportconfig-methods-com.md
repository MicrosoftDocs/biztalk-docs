...
The methods of the **IBTTransportConfig** interface are listed here. For a complete list of **IBTTransportConfig** interface members, see the [IBTTransportConfig Members](ibttransportconfig-members-com.md) topic.
