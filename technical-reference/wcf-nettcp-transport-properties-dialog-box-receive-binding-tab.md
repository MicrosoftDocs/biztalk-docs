...
<br />
The WCF-NetTcp adapter leverages the <a href="/dotnet/api/system.servicemodel.nettcpbinding">NetTcpBinding</a> class to communicate with an endpoint. When using the <a href="/dotnet/api/system.servicemodel.nettcpbinding">NetTcpBinding</a> in load-balanced scenarios, consider reducing the default lease timeout. For more information about the load balancing when using the <a href="/dotnet/api/system.servicemodel.nettcpbinding">NetTcpBinding</a>, see the appropriate topic in See Also.<br />
<br />
