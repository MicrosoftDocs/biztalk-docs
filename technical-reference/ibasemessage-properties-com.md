---
description: "Learn more about: IBaseMessage Properties (COM)"
title: IBaseMessage Properties (COM)
TOCTitle: IBaseMessage Properties (COM)
ms:assetid: 37b52ee5-0ba7-4069-bdb0-10aaaf0b6319
ms:mtpsurl: https://msdn.microsoft.com/library/Aa559605(v=BTS.80)
ms:contentKeyID: 51527364
ms.date: 08/30/2017
...
The properties of the **IBaseMessage** interface are listed here. For a complete list of **IBaseMessage** interface members, see the [IBaseMessage Members](ibasemessage-members-com.md) topic.
