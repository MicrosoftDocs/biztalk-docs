...
* **Major updates**: If you are making major updates, we recommend forking the repository (making a copy to your GitHub account), and make your edits within [Visual Studio Code](https://code.visualstudio.com/download). You can then submit your changes to the Live branch, where they are reviewed, and then merged & published.

* **Microsoft employees**: If you are a PFE, on the support team, program manager, or developer from the BizTalk or HIS product teams, then it's your job to contribute to or author technical articles. If you are making substantial changes to an existing article, adding or changing images, or contributing a new article, then we recommend that you fork this repository, install Git Bash, a markdown editor ([Visual Studio Code](https://code.visualstudio.com/download) is preferred), and learn some Git commands. The [internal contributor's guide](https://review.learn.microsoft.com/help/contribute/) provides the details to get started.
...
3. Use the **description** metadata attribute for SEO. The **title** attribute is used for search results. If the doc is missing a description, please add one. Here's an example:
